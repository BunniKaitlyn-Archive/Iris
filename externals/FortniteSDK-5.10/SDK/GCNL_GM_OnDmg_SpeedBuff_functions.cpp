...
{
	static auto Func = Class->GetFunction("GCNL_GM_OnDmg_SpeedBuff_C", "OnWhileActiveParticleSystemActivate");
...
{
	static auto Func = Class->GetFunction("GCNL_GM_OnDmg_SpeedBuff_C", "UserConstructionScript");

	Params::AGCNL_GM_OnDmg_SpeedBuff_C_UserConstructionScript_Params Parms;
