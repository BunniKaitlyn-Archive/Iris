...
{
	static auto Func = Class->GetFunction("GCL_PunchPack_Jump_Charge_C", "UserConstructionScript");

	Params::AGCL_PunchPack_Jump_Charge_C_UserConstructionScript_Params Parms;
...
void AGCL_PunchPack_Jump_Charge_C::ExecuteUbergraph_GCL_PunchPack_Jump_Charge(int32 EntryPoint, class UAudioComponent* CallFunc_SpawnSoundAttached_ReturnValue, bool Temp_bool_Whether_the_gate_is_currently_open_or_close_Variable, bool Temp_bool_Has_Been_Initd_Variable, bool Temp_bool_IsClosed_Variable, enum class EEndPlayReason K2Node_Event_EndPlayReason, bool K2Node_CustomEvent_Stop, class UAudioComponent* CallFunc_SpawnSoundAttached_ReturnValue1, class UParticleSystemComponent* CallFunc_SpawnEmitterAttached_ReturnValue, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue)
{
