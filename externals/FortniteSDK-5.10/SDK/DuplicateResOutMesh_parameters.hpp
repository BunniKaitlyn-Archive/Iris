...
public:
	...
	uint8                                        Pad_31E4[0x4];                                     
	class USkeletalMeshComponent*                CallFunc_Array_Get_Item3;                          // 0x178(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_Array_Length_ReturnValue1;                // 0x180(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_Less_IntInt_ReturnValue1;                 // 0x184(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
