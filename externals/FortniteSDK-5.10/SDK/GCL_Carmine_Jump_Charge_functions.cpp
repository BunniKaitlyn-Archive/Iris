...
bool AGCL_Carmine_Jump_Charge_C::WhileActive(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, class AFortPlayerPawnAthena* K2Node_DynamicCast_AsFort_Player_Pawn_Athena, bool K2Node_DynamicCast_bSuccess)
{
	static auto Func = Class->GetFunction("GCL_Carmine_Jump_Charge_C", "WhileActive");

	Params::AGCL_Carmine_Jump_Charge_C_WhileActive_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCL_Carmine_Jump_Charge_C", "OnRemove");

	Params::AGCL_Carmine_Jump_Charge_C_OnRemove_Params Parms;
	Parms.MyTarget = MyTarget;
	Parms.Parameters = Parameters;
...
{
	static auto Func = Class->GetFunction("GCL_Carmine_Jump_Charge_C", "OnWhileActiveParticleSystemDeactivate");

	Params::AGCL_Carmine_Jump_Charge_C_OnWhileActiveParticleSystemDeactivate_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCL_Carmine_Jump_Charge_C", "OnStartParticleSystemSpawned");

	Params::AGCL_Carmine_Jump_Charge_C_OnStartParticleSystemSpawned_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCL_Carmine_Jump_Charge_C", "UserConstructionScript");

	Params::AGCL_Carmine_Jump_Charge_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCL_Carmine_Jump_Charge_C", "ReceiveBeginPlay");

	Params::AGCL_Carmine_Jump_Charge_C_ReceiveBeginPlay_Params Parms;
...
void AGCL_Carmine_Jump_Charge_C::ReceiveEndPlay(enum class EEndPlayReason EndPlayReason)
{
	static auto Func = Class->GetFunction("GCL_Carmine_Jump_Charge_C", "ReceiveEndPlay");

	Params::AGCL_Carmine_Jump_Charge_C_ReceiveEndPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCL_Carmine_Jump_Charge_C", "ChargeDelay");

	Params::AGCL_Carmine_Jump_Charge_C_ChargeDelay_Params Parms;
	Parms.Stop = Stop;
...
void AGCL_Carmine_Jump_Charge_C::ExecuteUbergraph_GCL_Carmine_Jump_Charge(int32 EntryPoint, class UAudioComponent* CallFunc_SpawnSoundAttached_ReturnValue, bool Temp_bool_Whether_the_gate_is_currently_open_or_close_Variable, bool Temp_bool_Has_Been_Initd_Variable, bool Temp_bool_IsClosed_Variable, enum class EEndPlayReason K2Node_Event_EndPlayReason, bool K2Node_CustomEvent_Stop, class UAudioComponent* CallFunc_SpawnSoundAttached_ReturnValue1, class UParticleSystemComponent* CallFunc_SpawnEmitterAttached_ReturnValue, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue)
{
	static auto Func = Class->GetFunction("GCL_Carmine_Jump_Charge_C", "ExecuteUbergraph_GCL_Carmine_Jump_Charge");

	Params::AGCL_Carmine_Jump_Charge_C_ExecuteUbergraph_GCL_Carmine_Jump_Charge_Params Parms;
