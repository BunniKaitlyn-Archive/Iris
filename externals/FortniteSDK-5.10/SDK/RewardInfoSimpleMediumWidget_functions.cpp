...
{
	static auto Func = Class->GetFunction("RewardInfoSimpleMediumWidget_C", "HandleDifferentItemOrQuantitySetBP");

	Params::URewardInfoSimpleMediumWidget_C_HandleDifferentItemOrQuantitySetBP_Params Parms;
