...
bool UAnimNotify_EnemyDeathFX_On_C::Received_Notify(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation, bool CallFunc_IsDedicatedServer_ReturnValue, class AActor* CallFunc_GetOwner_ReturnValue, class AEnemyPawn_Parent_C* K2Node_DynamicCast_AsEnemy_Pawn_Parent, bool K2Node_DynamicCast_bSuccess)
{
	static auto Func = Class->GetFunction("AnimNotify_EnemyDeathFX_On_C", "Received_Notify");

	Params::UAnimNotify_EnemyDeathFX_On_C_Received_Notify_Params Parms;
