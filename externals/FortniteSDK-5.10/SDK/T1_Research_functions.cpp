...
{
	static auto Func = Class->GetFunction("T1_Research_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("T1_Research_C", "Construct");

	Params::UT1_Research_C_Construct_Params Parms;
...
{
	static auto Func = Class->GetFunction("T1_Research_C", "ExecuteUbergraph_T1_Research");
