...
void UVehicleInfoIndicator_C::ExecuteUbergraph_VehicleInfoIndicator(int32 EntryPoint, bool CallFunc_IsValid_ReturnValue, float CallFunc_GetMaxHealth_ReturnValue, float CallFunc_GetHealth_ReturnValue)
{
