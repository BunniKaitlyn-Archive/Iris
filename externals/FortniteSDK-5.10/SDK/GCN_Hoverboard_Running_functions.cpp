...
{
	static auto Func = Class->GetFunction("GCN_Hoverboard_Running_C", "UserConstructionScript");

	Params::AGCN_Hoverboard_Running_C_UserConstructionScript_Params Parms;
