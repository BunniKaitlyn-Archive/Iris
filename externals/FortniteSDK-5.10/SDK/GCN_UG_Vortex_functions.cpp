...
{
	static auto Func = Class->GetFunction("GCN_UG_Vortex_C", "UserConstructionScript");
...
{
	static auto Func = Class->GetFunction("GCN_UG_Vortex_C", "Timeline_0__FinishedFunc");

	Params::AGCN_UG_Vortex_C_Timeline_0__FinishedFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCN_UG_Vortex_C", "Timeline_0__UpdateFunc");

	Params::AGCN_UG_Vortex_C_Timeline_0__UpdateFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCN_UG_Vortex_C", "K2_HandleGameplayCue");
...
{
	static auto Func = Class->GetFunction("GCN_UG_Vortex_C", "ExecuteUbergraph_GCN_UG_Vortex");
