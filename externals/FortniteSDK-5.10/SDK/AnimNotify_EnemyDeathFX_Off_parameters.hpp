...
struct UAnimNotify_EnemyDeathFX_Off_C_Received_Notify_Params
{
public:
	...
	class AEnemyPawn_Parent_C*                   K2Node_DynamicCast_AsEnemy_Pawn_Parent;            // 0x20(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
