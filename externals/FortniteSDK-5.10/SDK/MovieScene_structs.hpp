...
public:
	...
	uint8                                        Pad_1CD[0x2];                                      
	struct FMovieSceneTangentData                Tangent;                                           // 0x8(0x14)(Edit, NoDestructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FFrameRate                            TickResolution;                                    // 0x98(0x8)(HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
...
{
public:
	struct FTimecode                             Timecode;                                          // 0x0(0x14)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFrameNumber                          DeltaFrame;                                        // 0x14(0x4)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FFrameTime                            Offset;                                            // 0x4(0x8)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FFrameRate                            TickResolution;                                    // 0x24(0x8)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_1E0[0x8];                                      
	struct FGuid                                 SubSectionSignature;                               // 0x88(0x10)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	struct FGuid                                 Guid;                                              // 0x10(0x10)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	struct FGuid                                 ParentGuid;                                        // 0x38(0x10)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
...
public:
	...
	struct FGuid                                 Guid;                                              // 0x40(0x10)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                        Pad_1F1[0x7];                                      
	class FName                                  LevelName;                                         // 0x80(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1F2[0x8];                                      
};
