...
{
	static auto Func = Class->GetFunction("AthenaReplayBrowserMatchStats_C", "Clear");

	Params::UAthenaReplayBrowserMatchStats_C_Clear_Params Parms;
...
// class FText                        CallFunc_Conv_IntToText_ReturnValue8                             ()
// class FText                        CallFunc_Conv_IntToText_ReturnValue9                             ()
...
// class FText                        CallFunc_Conv_IntToText_ReturnValue10                            ()
// class FText                        CallFunc_Conv_StringToText_ReturnValue1                          ()
// class FText                        CallFunc_Conv_IntToText_ReturnValue11                            ()
...
{
	static auto Func = Class->GetFunction("AthenaReplayBrowserMatchStats_C", "Refresh");
...
{
	static auto Func = Class->GetFunction("AthenaReplayBrowserMatchStats_C", "Construct");

	Params::UAthenaReplayBrowserMatchStats_C_Construct_Params Parms;
...
{
	static auto Func = Class->GetFunction("AthenaReplayBrowserMatchStats_C", "SetReplayInfo");
...
{
	static auto Func = Class->GetFunction("AthenaReplayBrowserMatchStats_C", "ExecuteUbergraph_AthenaReplayBrowserMatchStats");
