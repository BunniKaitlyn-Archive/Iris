...
{
	static auto Func = Class->GetFunction("GCNL_GM_Snare_C", "UserConstructionScript");

	Params::AGCNL_GM_Snare_C_UserConstructionScript_Params Parms;
