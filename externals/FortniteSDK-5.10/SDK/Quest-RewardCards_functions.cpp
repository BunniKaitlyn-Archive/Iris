...
void UQuest_RewardCards_C::PlayIntro(int32 Temp_int_Variable, class UWidgetAnimation* K2Node_Select_Default)
{
...
void UQuest_RewardCards_C::PlayBounceLoop(int32 Temp_int_Variable, class UWidgetAnimation* K2Node_Select_Default)
{
...
// struct FLinearColor                CallFunc_GetRaritySecondaryColor_ReturnValue                     (IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UQuest_RewardCards_C::ExecuteUbergraph_Quest_RewardCards(int32 EntryPoint, TArray<class UFortItemDefinition*>& CallFunc_GetDisplayItemDefs_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, int32 CallFunc_Subtract_IntInt_ReturnValue)
{
