...
public:
	...
	bool                                         CallFunc_GetIsEnabled_ReturnValue;                 // 0xD(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_507F[0x2];                                     
...
public:
	...
	struct FSlateBrush                           Brush;                                             // 0x18(0x88)(BlueprintVisible, BlueprintReadOnly, Parm)
	bool                                         Option_Enabled;                                    // 0xA0(0x1)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_5080[0x3];                                     
	int32                                        RadialItemIndex;                                   // 0xA4(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_Add_IntInt_ReturnValue;                   // 0xA8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_5081[0x4];                                     
	class FString                                CallFunc_BuildString_Int_ReturnValue;              // 0xB0(0x10)(ZeroConstructor, HasGetValueTypeHash)
