...
public:
	...
	enum class ESlateVisibility                  K2Node_Select1_Default;                            // 0x2A(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	uint8                                        Pad_4B69[0x7];                                     
	class UGridSlot*                             K2Node_DynamicCast_AsGrid_Slot1;                   // 0x10(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess1;                      // 0x18(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_4B6A[0x7];                                     
	class UGridSlot*                             K2Node_DynamicCast_AsGrid_Slot2;                   // 0x20(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	struct FMargin                               K2Node_MakeStruct_Margin;                          // 0x38(0x10)(IsPlainOldData, NoDestructor)
