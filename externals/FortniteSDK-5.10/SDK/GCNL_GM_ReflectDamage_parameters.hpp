...
public:
	...
	uint8                                        Pad_4877[0x4];                                     
	class USceneComponent*                       CallFunc_GetAttachParent_ReturnValue;              // 0xE8(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FRotator                              CallFunc_Conv_VectorToRotator_ReturnValue1;        // 0x128(0xC)(IsPlainOldData, NoDestructor)
	...
	struct FVector                               CallFunc_GetSocketLocation_ReturnValue1;           // 0x1C4(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_Subtract_VectorVector_ReturnValue1;       // 0x1D0(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
