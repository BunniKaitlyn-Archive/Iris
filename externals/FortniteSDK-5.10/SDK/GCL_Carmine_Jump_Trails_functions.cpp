...
{
	static auto Func = Class->GetFunction("GCL_Carmine_Jump_Trails_C", "UserConstructionScript");

	Params::AGCL_Carmine_Jump_Trails_C_UserConstructionScript_Params Parms;
