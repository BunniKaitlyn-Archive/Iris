...
{
	static auto Func = Class->GetFunction("GC_Commando_MakeItRain_C", "OnActive");
...
{
	static auto Func = Class->GetFunction("GC_Commando_MakeItRain_C", "OnRemove");
...
{
	static auto Func = Class->GetFunction("GC_Commando_MakeItRain_C", "UserConstructionScript");

	Params::AGC_Commando_MakeItRain_C_UserConstructionScript_Params Parms;
