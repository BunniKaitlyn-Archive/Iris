...
{
	static auto Func = Class->GetFunction("GA_DefaultPlayer_BuildingCreated_C", "K2_ActivateAbilityFromEvent");
...
{
	static auto Func = Class->GetFunction("GA_DefaultPlayer_BuildingCreated_C", "ExecuteUbergraph_GA_DefaultPlayer_BuildingCreated");
