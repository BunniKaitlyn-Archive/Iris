...
{
	static auto Func = Class->GetFunction("SocialPanel_C", "SocialPanelCloseRequested__DelegateSignature");

	Params::USocialPanel_C_SocialPanelCloseRequested__DelegateSignature_Params Parms;
