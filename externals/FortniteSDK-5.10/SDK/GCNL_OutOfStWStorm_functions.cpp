...
void AGCNL_OutOfStWStorm_C::OnStormAudio()
{
	static auto Func = Class->GetFunction("GCNL_OutOfStWStorm_C", "OnStormAudio");

	Params::AGCNL_OutOfStWStorm_C_OnStormAudio_Params Parms;
...
// struct FVector                     CallFunc_GetLocationInCircleXY_LocationLocalSpace                (IsPlainOldData, NoDestructor, HasGetValueTypeHash)
