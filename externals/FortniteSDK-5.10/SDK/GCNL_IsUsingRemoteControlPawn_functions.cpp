...
{
	static auto Func = Class->GetFunction("GCNL_IsUsingRemoteControlPawn_C", "UserConstructionScript");

	Params::AGCNL_IsUsingRemoteControlPawn_C_UserConstructionScript_Params Parms;
