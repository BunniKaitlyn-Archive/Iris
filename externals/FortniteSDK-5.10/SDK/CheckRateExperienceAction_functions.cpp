...
{
	static auto Func = Class->GetFunction("CheckRateExperienceAction_C", "UserConstructionScript");

	Params::ACheckRateExperienceAction_C_UserConstructionScript_Params Parms;
