...
{
	static auto Func = Class->GetFunction("GCNL_GM_OnDmgReceived_Slow_C", "UserConstructionScript");

	Params::AGCNL_GM_OnDmgReceived_Slow_C_UserConstructionScript_Params Parms;
