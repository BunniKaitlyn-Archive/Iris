...
{
	static auto Func = Class->GetFunction("GCL_IntelPack_Highlight_C", "UserConstructionScript");

	Params::AGCL_IntelPack_Highlight_C_UserConstructionScript_Params Parms;
