...
struct ATrap_Floor_Hoverboard_Speed_C_UserConstructionScript_Params
{
public:
};
...
public:
	...
	struct FVector                               CallFunc_K2_GetActorLocation_ReturnValue2;         // 0x20(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
