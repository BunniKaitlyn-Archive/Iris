...
{
	static auto Func = Class->GetFunction("FortnitePartyBackdrop_Camera_C", "UserConstructionScript");

	Params::AFortnitePartyBackdrop_Camera_C_UserConstructionScript_Params Parms;
