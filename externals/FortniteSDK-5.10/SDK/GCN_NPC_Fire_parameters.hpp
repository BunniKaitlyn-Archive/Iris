...
public:
	...
	uint8                                        Pad_4866[0x6];                                     
	class ASmasherPawn_C*                        K2Node_DynamicCast_AsSmasher_Pawn;                 // 0xC8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0xD0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};

// 0x0 (0x0 - 0x0)
// Function GCN_NPC_Fire.GCN_NPC_Fire_C.UserConstructionScript
struct AGCN_NPC_Fire_C_UserConstructionScript_Params
{
public:
};
