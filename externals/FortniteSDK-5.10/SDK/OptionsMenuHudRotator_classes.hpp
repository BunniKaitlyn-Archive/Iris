...
public:
	...
	void UpdateSize(const struct FVector2D& LargeSize, const struct FVector2D& SmallSize, class UClass* Temp_class_Variable, bool Temp_bool_Variable, bool Temp_bool_Variable1, bool CallFunc_IsMobileGame_ReturnValue, bool CallFunc_IsMobileGame_ReturnValue1, const struct FVector2D& K2Node_Select_Default, class UClass* Temp_class_Variable1, const struct FVector2D& K2Node_Select1_Default, bool Temp_bool_Variable2, class UClass* K2Node_Select2_Default, const struct FSlateBrush& K2Node_MakeStruct_SlateBrush, const struct FSlateBrush& K2Node_MakeStruct_SlateBrush1);
