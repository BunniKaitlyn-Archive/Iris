...
{
	static auto Func = Class->GetFunction("AthenaTeamScoreWidget_C", "UpdateScore");
...
{
	static auto Func = Class->GetFunction("AthenaTeamScoreWidget_C", "OnScoreChanged");
...
{
	static auto Func = Class->GetFunction("AthenaTeamScoreWidget_C", "OnPlacementChanged");
...
{
	static auto Func = Class->GetFunction("AthenaTeamScoreWidget_C", "Construct");

	Params::UAthenaTeamScoreWidget_C_Construct_Params Parms;
...
{
	static auto Func = Class->GetFunction("AthenaTeamScoreWidget_C", "PreConstruct");
...
void UAthenaTeamScoreWidget_C::ExecuteUbergraph_AthenaTeamScoreWidget(int32 EntryPoint, bool K2Node_Event_IsDesignTime, int32 K2Node_Event_Placement, class UMaterialInstanceDynamic* CallFunc_GetDynamicMaterial_ReturnValue, int32 K2Node_Event_Score, class UOverlaySlot* CallFunc_SlotAsOverlaySlot_ReturnValue)
{
	static auto Func = Class->GetFunction("AthenaTeamScoreWidget_C", "ExecuteUbergraph_AthenaTeamScoreWidget");
