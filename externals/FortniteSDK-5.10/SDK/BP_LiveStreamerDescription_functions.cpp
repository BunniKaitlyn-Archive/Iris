...
void UBP_LiveStreamerDescription_C::Update_Viewer_Note_Visibility(bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, bool CallFunc_Is_Viewer_Quest_ViewerQuest, enum class ESlateVisibility K2Node_Select_Default)
{
...
void UBP_LiveStreamerDescription_C::Is_Viewer_Quest(bool* ViewerQuest, enum class EFortQuestType CallFunc_GetQuestType_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue1, bool CallFunc_BooleanOR_ReturnValue)
{
