...
{
	static auto Func = Class->GetFunction("AthenaReplayHUD_C", "SetNameplateLayerDataSource");

	Params::UAthenaReplayHUD_C_SetNameplateLayerDataSource_Params Parms;
...
void UAthenaReplayHUD_C::SetNameplateLayerVisibility(bool bNameplatesEnabled, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, enum class ESlateVisibility K2Node_Select_Default)
{
	static auto Func = Class->GetFunction("AthenaReplayHUD_C", "SetNameplateLayerVisibility");

	Params::UAthenaReplayHUD_C_SetNameplateLayerVisibility_Params Parms;
