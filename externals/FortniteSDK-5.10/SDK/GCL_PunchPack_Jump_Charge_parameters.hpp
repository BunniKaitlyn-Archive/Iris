...
struct AGCL_PunchPack_Jump_Charge_C_UserConstructionScript_Params
{
public:
};
...
public:
	...
	enum class EEndPlayReason                    K2Node_Event_EndPlayReason;                        // 0x13(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_CustomEvent_Stop;                           // 0x14(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_489E[0x3];                                     
	class UAudioComponent*                       CallFunc_SpawnSoundAttached_ReturnValue1;          // 0x18(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
