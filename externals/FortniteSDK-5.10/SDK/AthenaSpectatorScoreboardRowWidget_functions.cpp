...
// Parameters:
// class UClass*                      IrrelevantStyle                                                  (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UClass*                      DefaultStyle                                                     (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UClass*                      DeadStyle                                                        (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
{
	static auto Func = Class->GetFunction("AthenaSpectatorScoreboardRowWidget_C", "OnEntryDataSet");

	Params::UAthenaSpectatorScoreboardRowWidget_C_OnEntryDataSet_Params Parms;
...
{
	static auto Func = Class->GetFunction("AthenaSpectatorScoreboardRowWidget_C", "ExecuteUbergraph_AthenaSpectatorScoreboardRowWidget");

	Params::UAthenaSpectatorScoreboardRowWidget_C_ExecuteUbergraph_AthenaSpectatorScoreboardRowWidget_Params Parms;
