...
public:
	...
	uint8                                        Pad_5178[0x4];                                     
	class UStatsListWidget_C*                    K2Node_DynamicCast_AsStats_List_Widget;            // 0x8(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
