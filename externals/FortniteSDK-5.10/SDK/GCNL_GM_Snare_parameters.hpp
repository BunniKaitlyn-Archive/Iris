...
public:
	...
	float                                        CallFunc_MakeLiteralFloat_ReturnValue1;            // 0xC4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_Multiply_FloatFloat_ReturnValue;          // 0xC8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_Multiply_FloatFloat_ReturnValue1;         // 0xCC(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                        CallFunc_Multiply_FloatFloat_ReturnValue2;         // 0x10C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_MakeVector_ReturnValue1;                  // 0x110(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_4875[0xC];                                     
	struct FParticleSysParam                     K2Node_MakeStruct_ParticleSysParam1;               // 0x1B0(0x80)(IsPlainOldData, NoDestructor)
