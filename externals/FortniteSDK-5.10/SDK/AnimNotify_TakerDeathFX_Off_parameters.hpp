...
struct UAnimNotify_TakerDeathFX_Off_C_Received_Notify_Params
{
public:
	...
	class ATakerPawn_C*                          K2Node_DynamicCast_AsTaker_Pawn;                   // 0x20(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
