...
public:
	...
	enum class ESlateVisibility                  Temp_byte_Variable1;                               // 0x13C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	class UTutorialTransparentRichText_C*        CallFunc_Create_ReturnValue1;                      // 0x58(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	class UObject*                               K2Node_HandleClientEvent_EventSource1;             // 0x150(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UObject*                               K2Node_HandleClientEvent_EventFocus1;              // 0x158(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FFortClientEvent                      K2Node_HandleClientEvent_ClientEvent1;             // 0x160(0x20)(ConstParm, NoDestructor)
	...
	class UFortFrontEndContext*                  CallFunc_GetContext_ReturnValue1;                  // 0x308(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
