...
{
	static auto Func = Class->GetFunction("AIController", "OnUnpossess");

	Params::AAIController_OnUnpossess_Params Parms;
...
{
	static auto Func = Class->GetFunction("AIController", "OnPossess");
