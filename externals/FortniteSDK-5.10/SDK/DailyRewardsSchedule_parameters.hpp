...
public:
	...
	class UDailyRewardsEpic_C*                   CallFunc_Create_ReturnValue;                       // 0x50(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData3;             // 0x138(0x40)(HasGetValueTypeHash)
	...
	class FText                                  CallFunc_Format_ReturnValue2;                      // 0x1A0(0x18)()
	...
	class UDailyRewardsItem_C*                   CallFunc_Create_ReturnValue1;                      // 0x1C8(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UDailyRewardsItem_C*                   CallFunc_Create_ReturnValue2;                      // 0x1D0(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UHorizontalBoxSlot*                    CallFunc_AddChildToHorizontalBox_ReturnValue1;     // 0x1D8(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_515A[0x4];                                     
	class UHorizontalBoxSlot*                    CallFunc_AddChildToHorizontalBox_ReturnValue2;     // 0x1F0(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FSlateChildSize                       K2Node_MakeStruct_SlateChildSize;                  // 0x1F8(0x8)(NoDestructor)
	int32                                        CallFunc_Array_Length_ReturnValue1;                // 0x200(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_Add_IntInt_ReturnValue1;                  // 0x204(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FMargin                               K2Node_MakeStruct_Margin;                          // 0x208(0x10)(IsPlainOldData, NoDestructor)
	...
	uint8                                        Pad_515C[0x3];                                     
	struct FFortDailyRewardsItemData             CallFunc_Array_Get_Item;                           // 0x228(0x10)(NoDestructor)
	bool                                         CallFunc_Less_IntInt_ReturnValue1;                 // 0x238(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_515D[0x3];                                     
	int32                                        CallFunc_Subtract_IntInt_ReturnValue;              // 0x23C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_Less_IntInt_ReturnValue2;                 // 0x240(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_515E[0x7];                                     
	struct FFortDailyRewardsItemData             CallFunc_Array_Get_Item1;                          // 0x248(0x10)(NoDestructor)
	bool                                         CallFunc_BooleanOR_ReturnValue;                    // 0x258(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_515F[0x3];                                     
	int32                                        CallFunc_Add_IntInt_ReturnValue2;                  // 0x25C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_Subtract_IntInt_ReturnValue1;             // 0x260(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_LessEqual_IntInt_ReturnValue;             // 0x264(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
