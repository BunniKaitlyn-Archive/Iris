...
{
	static auto Func = Class->GetFunction("CollectionMultiProgressBar_C", "PlayFlashAnimation");

	Params::UCollectionMultiProgressBar_C_PlayFlashAnimation_Params Parms;
...
// bool                               CallFunc_IsAchievedCountInRange_bIsInRange                       (ZeroConstructor, IsPlainOldData, NoDestructor)
...
// class UCollectionBar_C*            K2Node_DynamicCast_AsCollection_Bar                              (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// int32                              CallFunc_GetChildIndex_ReturnValue1                              (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// bool                               CallFunc_IsAchievedCountInRange_bIsInRange1                      (ZeroConstructor, IsPlainOldData, NoDestructor)
...
{
	static auto Func = Class->GetFunction("CollectionMultiProgressBar_C", "UpdateVisibleBar");

	Params::UCollectionMultiProgressBar_C_UpdateVisibleBar_Params Parms;
	Parms.Temp_bool_Variable = Temp_bool_Variable;
	Parms.CallFunc_GetChildIndex_ReturnValue = CallFunc_GetChildIndex_ReturnValue;
	Parms.CallFunc_IsAchievedCountInRange_bIsInRange = CallFunc_IsAchievedCountInRange_bIsInRange;
	...
	Parms.K2Node_DynamicCast_AsCollection_Bar = K2Node_DynamicCast_AsCollection_Bar;
	Parms.K2Node_DynamicCast_bSuccess = K2Node_DynamicCast_bSuccess;
	Parms.CallFunc_Subtract_IntInt_ReturnValue1 = CallFunc_Subtract_IntInt_ReturnValue1;
	Parms.CallFunc_GetChildIndex_ReturnValue1 = CallFunc_GetChildIndex_ReturnValue1;
	...
	Parms.CallFunc_IsAchievedCountInRange_bIsInRange1 = CallFunc_IsAchievedCountInRange_bIsInRange1;
...
void UCollectionMultiProgressBar_C::Update(int32 AchievedCount, int32 Temp_int_Variable, class UWidget* CallFunc_GetChildAt_ReturnValue, int32 CallFunc_GetChildrenCount_ReturnValue, class UCollectionBar_C* K2Node_DynamicCast_AsCollection_Bar, bool K2Node_DynamicCast_bSuccess, int32 CallFunc_Subtract_IntInt_ReturnValue, bool CallFunc_LessEqual_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue)
{
	static auto Func = Class->GetFunction("CollectionMultiProgressBar_C", "Update");

	Params::UCollectionMultiProgressBar_C_Update_Params Parms;
...
// struct FCollectionMissionBadgeDisplayInfoCallFunc_Array_Get_Item                                          (HasGetValueTypeHash)
// bool                               CallFunc_IsValid_ReturnValue                                     (ZeroConstructor, IsPlainOldData, NoDestructor)
// class APlayerController*           CallFunc_GetOwningPlayer_ReturnValue                             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UCollectionBarTopIcon_C*     CallFunc_Create_ReturnValue                                      (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UCollectionBar_C*            CallFunc_Create_ReturnValue1                                     (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
{
	static auto Func = Class->GetFunction("CollectionMultiProgressBar_C", "Construct");

	Params::UCollectionMultiProgressBar_C_Construct_Params Parms;
...
{
	static auto Func = Class->GetFunction("CollectionMultiProgressBar_C", "ExecuteUbergraph_CollectionMultiProgressBar");

	Params::UCollectionMultiProgressBar_C_ExecuteUbergraph_CollectionMultiProgressBar_Params Parms;
