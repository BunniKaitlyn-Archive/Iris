...
{
	static auto Func = Class->GetFunction("SurvivorSquadBonusTraitsDetailWidget_C", "HandlePostDifferentSquadSlotSetBP");

	Params::USurvivorSquadBonusTraitsDetailWidget_C_HandlePostDifferentSquadSlotSetBP_Params Parms;
...
{
	static auto Func = Class->GetFunction("SurvivorSquadBonusTraitsDetailWidget_C", "HandleTraitValuesUpdatedBP");

	Params::USurvivorSquadBonusTraitsDetailWidget_C_HandleTraitValuesUpdatedBP_Params Parms;
...
{
	static auto Func = Class->GetFunction("SurvivorSquadBonusTraitsDetailWidget_C", "HandlePostDifferentItemToDetailSet");

	Params::USurvivorSquadBonusTraitsDetailWidget_C_HandlePostDifferentItemToDetailSet_Params Parms;
...
{
	static auto Func = Class->GetFunction("SurvivorSquadBonusTraitsDetailWidget_C", "ExecuteUbergraph_SurvivorSquadBonusTraitsDetailWidget");
