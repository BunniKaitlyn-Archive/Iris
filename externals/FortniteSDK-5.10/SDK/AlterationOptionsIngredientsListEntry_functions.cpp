...
// class UFortItemDefinition*         CallFunc_GetItemDefinition_ReturnValue                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UFortItemDefinition*         CallFunc_GetItemDefinition_ReturnValue1                          (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UAlterationOptionsIngredientsListEntry_C::ExecuteUbergraph_AlterationOptionsIngredientsListEntry(int32 EntryPoint, bool K2Node_Event_IsBeingReset, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UFortItemDefinition* CallFunc_GetItemDefinition_ReturnValue, class UFortItemDefinition* CallFunc_GetItemDefinition_ReturnValue1, class FText CallFunc_GetDisplayName_ReturnValue, class FText CallFunc_GetSingleLineDescription_ReturnValue, class UUserWidget* CallFunc_Create_Basic_Tooltip_Output)
{
	...
	Parms.CallFunc_GetItemDefinition_ReturnValue = CallFunc_GetItemDefinition_ReturnValue;
	Parms.CallFunc_GetItemDefinition_ReturnValue1 = CallFunc_GetItemDefinition_ReturnValue1;
