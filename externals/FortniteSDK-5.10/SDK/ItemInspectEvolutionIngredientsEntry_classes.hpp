...
public:
	...
	struct FFortItemQuantityPair                 IngredientItemQuantity;                            // 0x230(0x40)(Edit, BlueprintVisible, ExposeOnSpawn)
	struct FSlateColor                           NotHaveColor;                                      // 0x270(0x28)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FSlateColor                           HaveColor;                                         // 0x298(0x28)(Edit, BlueprintVisible, DisableEditOnInstance)
