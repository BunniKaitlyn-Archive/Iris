...
{
	static auto Func = Class->GetFunction("GCL_MedicPack_FuelRegen_C", "UserConstructionScript");

	Params::AGCL_MedicPack_FuelRegen_C_UserConstructionScript_Params Parms;
