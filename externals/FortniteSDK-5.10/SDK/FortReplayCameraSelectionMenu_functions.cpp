...
{
	static auto Func = Class->GetFunction("FortReplayCameraSelectionMenu_C", "Construct");

	Params::UFortReplayCameraSelectionMenu_C_Construct_Params Parms;
...
{
	static auto Func = Class->GetFunction("FortReplayCameraSelectionMenu_C", "ExecuteUbergraph_FortReplayCameraSelectionMenu");
