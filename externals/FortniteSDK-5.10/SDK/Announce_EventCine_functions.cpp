...
{
	static auto Func = Class->GetFunction("Announce_EventCine_C", "UserConstructionScript");

	Params::AAnnounce_EventCine_C_UserConstructionScript_Params Parms;
