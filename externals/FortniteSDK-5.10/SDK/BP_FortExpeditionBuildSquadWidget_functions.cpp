...
{
	static auto Func = Class->GetFunction("BP_FortExpeditionBuildSquadWidget_C", "Handle Sort Picker Action");

	Params::UBP_FortExpeditionBuildSquadWidget_C_Handle_Sort_Picker_Action_Params Parms;
...
// enum class EFortBuffState          CallFunc_Determine_Preview_State_State                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// enum class EFortBuffState          CallFunc_Determine_Preview_State_State1                          (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// enum class EFortBuffState          State                                                            (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_Less_FloatFloat_ReturnValue                             (ZeroConstructor, IsPlainOldData, NoDestructor)
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class FName                        CurrentSquadId                                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                              CallFunc_Get_Selected_Slot__SAFE__ReturnValue                    (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UBP_FortExpeditionBuildSquadWidget_C::Update_Vehicle_Selected(class FName CurrentSquadId, int32 CallFunc_Get_Selected_Slot__SAFE__ReturnValue, int32 CallFunc_Get_Selected_Slot__SAFE__ReturnValue1, class UWidget* CallFunc_GetChildAt_ReturnValue, bool CallFunc_NotEqual_NameName_ReturnValue, bool CallFunc_Handle_Close_Picker_Action_PassThrough, class UFortUINavigationManager* CallFunc_GetUINavigationManager_ReturnValue)
{
...
void UBP_FortExpeditionBuildSquadWidget_C::Handle_Squad_Slot_Selected(const struct FSquadSlotSortTypes& CallFunc_TryGetSelectedSquadSlotSortTypes_OutSlotSortTypes, bool CallFunc_TryGetSelectedSquadSlotSortTypes_ReturnValue, enum class EInputActionState CallFunc_Get_Slot_Item_State_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue)
{
	...
	Parms.CallFunc_TryGetSelectedSquadSlotSortTypes_OutSlotSortTypes = CallFunc_TryGetSelectedSquadSlotSortTypes_OutSlotSortTypes;
...
// enum class EInputActionState       CallFunc_Get_Purchase_Slot_State_ReturnValue2                    (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
