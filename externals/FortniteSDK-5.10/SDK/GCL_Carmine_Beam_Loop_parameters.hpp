...
public:
	...
	uint8                                        Pad_48CC[0x3];                                     
	struct FVector                               CallFunc_K2_GetComponentLocation_ReturnValue;      // 0xD4(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	enum class EEndPlayReason                    K2Node_Event_EndPlayReason;                        // 0xD0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
