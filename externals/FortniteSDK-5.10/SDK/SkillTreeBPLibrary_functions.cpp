...
// Parameters:
// enum class EFortHomebaseNodeMagnitudeNode_Magnitude                                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// enum class EFortHomebaseNodeMagnitudeTemp_byte_Variable                                               (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// enum class EFortBrushSize          Temp_byte_Variable1                                              (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void USkillTreeBPLibrary_C::GetSkillTreeNodeIconSizeByMagnitude(enum class EFortHomebaseNodeMagnitude Node_Magnitude, class UObject* __WorldContext, enum class EFortBrushSize* Icon_Size, enum class EFortHomebaseNodeMagnitude Temp_byte_Variable, enum class EFortBrushSize Temp_byte_Variable1, enum class EFortBrushSize Temp_byte_Variable2, enum class EFortBrushSize Temp_byte_Variable3, enum class EFortBrushSize Temp_byte_Variable4, enum class EFortBrushSize K2Node_Select_Default)
{
...
// (Static, Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// enum class EFortHomebaseNodeDisplayTypeDisplay_Type                                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UObject*                     __WorldContext                                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// enum class EFortHomebaseNodeDisplayTypeTemp_byte_Variable                                               (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// enum class EFortHomebaseNodeDisplayTypeTemp_byte_Variable1                                              (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void USkillTreeBPLibrary_C::GetSkillTreeNodeShapeByDisplayType(enum class EFortHomebaseNodeDisplayType Display_Type, class UObject* __WorldContext, bool* IsSquare, bool* IsExitNode, enum class EFortHomebaseNodeDisplayType Temp_byte_Variable, bool Temp_bool_Variable, bool Temp_bool_Variable1, bool Temp_bool_Variable2, bool Temp_bool_Variable3, bool Temp_bool_Variable4, bool Temp_bool_Variable5, bool Temp_bool_Variable6, enum class EFortHomebaseNodeDisplayType Temp_byte_Variable1, bool K2Node_Select_Default, bool Temp_bool_Variable7, bool Temp_bool_Variable8, bool Temp_bool_Variable9, bool Temp_bool_Variable10, bool Temp_bool_Variable11, bool Temp_bool_Variable12, bool Temp_bool_Variable13, bool K2Node_Select1_Default)
{
...
void USkillTreeBPLibrary_C::UpdateSkillTreeNodeMaterial_DynamicData(class UObject* World_Context, class UMaterialInstanceDynamic* Material, const struct FHomebaseNodeState& NodeState, class UObject* __WorldContext, float CallFunc_Conv_BoolToFloat_ReturnValue, float CallFunc_Conv_BoolToFloat_ReturnValue1, bool CallFunc_BooleanAND_ReturnValue, float CallFunc_Conv_BoolToFloat_ReturnValue2)
{
...
// struct FFortSkillTreeNodeDisplayDataDisplayData                                                      (BlueprintVisible, BlueprintReadOnly, Parm)
