...
{
	static auto Func = Class->GetFunction("TooltipStatWidget_C", "Construct");

	Params::UTooltipStatWidget_C_Construct_Params Parms;
...
{
	static auto Func = Class->GetFunction("TooltipStatWidget_C", "BndEvt__ButtonHover_K2Node_ComponentBoundEvent_1026_OnButtonHoverEvent__DelegateSignature");

	Params::UTooltipStatWidget_C_BndEvt__ButtonHover_K2Node_ComponentBoundEvent_1026_OnButtonHoverEvent__DelegateSignature_Params Parms;
...
{
	static auto Func = Class->GetFunction("TooltipStatWidget_C", "BndEvt__ButtonHover_K2Node_ComponentBoundEvent_1037_OnButtonHoverEvent__DelegateSignature");

	Params::UTooltipStatWidget_C_BndEvt__ButtonHover_K2Node_ComponentBoundEvent_1037_OnButtonHoverEvent__DelegateSignature_Params Parms;
...
{
	static auto Func = Class->GetFunction("TooltipStatWidget_C", "ExecuteUbergraph_TooltipStatWidget");
