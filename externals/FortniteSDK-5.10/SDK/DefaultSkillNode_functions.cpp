...
// enum class ESkillTreeGroups        Temp_byte_Variable3                                              (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// enum class EFortHomebaseNodeMagnitudeTemp_byte_Variable3                                              (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
{
	static auto Func = Class->GetFunction("DefaultSkillNode_C", "BP_OnUnhovered");

	Params::UDefaultSkillNode_C_BP_OnUnhovered_Params Parms;
...
{
	static auto Func = Class->GetFunction("DefaultSkillNode_C", "BP_OnHovered");

	Params::UDefaultSkillNode_C_BP_OnHovered_Params Parms;
...
{
	static auto Func = Class->GetFunction("DefaultSkillNode_C", "BP_OnSelected");

	Params::UDefaultSkillNode_C_BP_OnSelected_Params Parms;
...
{
	static auto Func = Class->GetFunction("DefaultSkillNode_C", "BP_OnDeselected");

	Params::UDefaultSkillNode_C_BP_OnDeselected_Params Parms;
