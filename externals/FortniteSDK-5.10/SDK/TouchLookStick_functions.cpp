...
// bool                               CallFunc_CheckForTag_HasTag2                                     (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_BooleanOR_ReturnValue                                   (ZeroConstructor, IsPlainOldData, NoDestructor)

void UTouchLookStick_C::SetBrushForStatus(bool InBuild_or_Edit_Mode, bool Is_RC_Pawn, bool* Found_Context, UInterfaceProperty_ CallFunc_SetBrushFromAtlasInterface_AtlasRegion_CastInput, UInterfaceProperty_ CallFunc_SetBrushFromAtlasInterface_AtlasRegion1_CastInput, UInterfaceProperty_ CallFunc_SetBrushFromAtlasInterface_AtlasRegion2_CastInput, bool CallFunc_CheckForTag_HasTag, bool CallFunc_CheckForTag_HasTag1, UInterfaceProperty_ CallFunc_SetBrushFromAtlasInterface_AtlasRegion3_CastInput, UInterfaceProperty_ CallFunc_SetBrushFromAtlasInterface_AtlasRegion4_CastInput, bool CallFunc_CheckForTag_HasTag2, bool CallFunc_BooleanOR_ReturnValue)
{
	...
	Parms.CallFunc_CheckForTag_HasTag2 = CallFunc_CheckForTag_HasTag2;
...
// bool                               CallFunc_GetDedicatedButtonEnabled_ReturnValue                   (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_SetBrushForStatus_Found_Context                         (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_BooleanOR_ReturnValue                                   (ZeroConstructor, IsPlainOldData, NoDestructor)

void UTouchLookStick_C::HandleWeaponChanged(bool In_Build_or_Edit_Mode, bool RC_Pawn, bool CallFunc_GetDedicatedButtonEnabled_ReturnValue, bool CallFunc_SetBrushForStatus_Found_Context, bool CallFunc_BooleanOR_ReturnValue)
{
	...
	Parms.CallFunc_GetDedicatedButtonEnabled_ReturnValue = CallFunc_GetDedicatedButtonEnabled_ReturnValue;
...
void UTouchLookStick_C::Fire_Mode_Changed(enum class EFireModeType NewFireMode)
{
	static auto Func = Class->GetFunction("TouchLookStick_C", "Fire Mode Changed");

	Params::UTouchLookStick_C_Fire_Mode_Changed_Params Parms;
...
void UTouchLookStick_C::ExecuteUbergraph_TouchLookStick(int32 EntryPoint, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, bool K2Node_Event_IsDesignTime, bool K2Node_Event_IsFiring, class AFortWeapon* K2Node_CustomEvent_NewWeapon, class AFortWeapon* K2Node_CustomEvent_PrevWeapon, const struct FFortHUDState& K2Node_Event_NewState, class UHUDLayoutToolContext* CallFunc_GetContext_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1, bool CallFunc_GetDedicatedButtonEnabled_ReturnValue, class UFortHUDContext* CallFunc_GetContext_ReturnValue1, const struct FFortHUDState& CallFunc_GetCurrentHUDState_ReturnValue, enum class EFireModeType K2Node_CustomEvent_NewFireMode, bool CallFunc_BooleanOR_ReturnValue1)
{
