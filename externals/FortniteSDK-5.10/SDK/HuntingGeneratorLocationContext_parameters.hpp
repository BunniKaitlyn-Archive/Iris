...
public:
	...
	struct FVector                               FinalHuntingRadiusLocationToUse;                   // 0x30(0xC)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               GoalActorLocation;                                 // 0x44(0xC)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               QuerierLocation;                                   // 0x50(0xC)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3984[0x4];                                     
	...
	struct FVector                               CallFunc_SelectVector_ReturnValue;                 // 0xC8(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_Multiply_FloatFloat_ReturnValue1;         // 0xD4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_Multiply_VectorFloat_ReturnValue1;        // 0xD8(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_398A[0x3];                                     
	struct FVector                               CallFunc_K2_GetActorLocation_ReturnValue2;         // 0x12C(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
