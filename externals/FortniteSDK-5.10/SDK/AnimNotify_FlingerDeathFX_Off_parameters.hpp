...
struct UAnimNotify_FlingerDeathFX_Off_C_Received_Notify_Params
{
public:
	...
	class AFlingerPawn_C*                        K2Node_DynamicCast_AsFlinger_Pawn;                 // 0x20(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
