...
struct UIsPlayingMontage_C_PerformConditionCheckAI_Params
{
public:
	...
	bool                                         CallFunc_HasCurrentMontage_ReturnValue;            // 0x21(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
