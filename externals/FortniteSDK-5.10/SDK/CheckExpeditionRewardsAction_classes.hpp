...
public:
	...
	bool                                         ShowRewardsWidget;                                 // 0x3F8(0x1)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                        Pad_4CD6[0x7];                                     
	class UFrontEndRewards_Widget_C*             Claimed_Reward_Widget;                             // 0x400(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
