...
{
	static auto Func = Class->GetFunction("Announce_TutorialConversation_C", "UserConstructionScript");

	Params::AAnnounce_TutorialConversation_C_UserConstructionScript_Params Parms;
...
void AAnnounce_TutorialConversation_C::ExecuteUbergraph_Announce_TutorialConversation(int32 EntryPoint, bool CallFunc_PlayConversation_ReturnValue, const struct FFortConversationSentence& K2Node_Event_FinishingSentence, int32 K2Node_Event_FinishingSentenceSentenceIndex, int32 CallFunc_Array_Length_ReturnValue, const struct FFortConversationSentence& K2Node_Event_Sentence1, int32 K2Node_Event_SentenceIndex1, const struct FTutorialHighlightData& CallFunc_Array_Get_Item, bool CallFunc_Less_IntInt_ReturnValue, bool CallFunc_NotEqual_NameName_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, const struct FFortConversationSentence& K2Node_Event_Sentence, int32 K2Node_Event_SentenceIndex, int32 CallFunc_Add_IntInt_ReturnValue, bool CallFunc_PlayConversationFromSentenceIndex_ReturnValue)
{
	...
	Parms.K2Node_Event_Sentence1 = K2Node_Event_Sentence1;
	Parms.K2Node_Event_SentenceIndex1 = K2Node_Event_SentenceIndex1;
