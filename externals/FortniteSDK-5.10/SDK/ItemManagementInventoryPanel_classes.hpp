...
public:
	...
	int32                                        Tile_View_Count;                                   // 0x444(0x4)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FTimerHandle                          Tile_View_List_Time_Handle;                        // 0x448(0x8)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	...
	void Trigger_Population_Anim(UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue);
