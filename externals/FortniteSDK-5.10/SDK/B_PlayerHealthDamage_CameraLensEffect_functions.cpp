...
{
	static auto Func = Class->GetFunction("B_PlayerHealthDamage_CameraLensEffect_C", "UserConstructionScript");

	Params::AB_PlayerHealthDamage_CameraLensEffect_C_UserConstructionScript_Params Parms;
...
void AB_PlayerHealthDamage_CameraLensEffect_C::ExecuteUbergraph_B_PlayerHealthDamage_CameraLensEffect(int32 EntryPoint, float K2Node_CustomEvent_NewParam, bool K2Node_CustomEvent_First_Hit, float CallFunc_Subtract_FloatFloat_ReturnValue, float CallFunc_Divide_FloatFloat_ReturnValue, float CallFunc_Subtract_FloatFloat_ReturnValue1)
{
