...
{
	static auto Func = Class->GetFunction("GCNL_Generic_BotTurret_C", "UserConstructionScript");

	Params::AGCNL_Generic_BotTurret_C_UserConstructionScript_Params Parms;
