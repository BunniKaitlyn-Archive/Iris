...
public:
	...
	float                                        PostTriggerCancelDelay;                            // 0x8E0(0x4)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         HideReticle;                                       // 0x8E4(0x1)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                        Pad_2E09[0x3];                                     
	struct FGameplayTagContainer                 ReticleHUDElementTags;                             // 0x8E8(0x20)(Edit, BlueprintVisible, DisableEditOnInstance)
