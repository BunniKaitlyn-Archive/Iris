...
void URewards_ItemCard_C::SetItemLimitReachedNotification(bool ShouldShow, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, enum class ESlateVisibility K2Node_Select_Default)
{
	static auto Func = Class->GetFunction("Rewards_ItemCard_C", "SetItemLimitReachedNotification");

	Params::URewards_ItemCard_C_SetItemLimitReachedNotification_Params Parms;
...
{
	static auto Func = Class->GetFunction("Rewards_ItemCard_C", "SetQuantityOverride");

	Params::URewards_ItemCard_C_SetQuantityOverride_Params Parms;
...
void URewards_ItemCard_C::SetOutpostInventoryNotification(bool ShouldShow, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, enum class ESlateVisibility K2Node_Select_Default)
{
...
void URewards_ItemCard_C::SetItemToRepresent(class UFortItem* Item, class UFortInventoryContext* CallFunc_GetContext_ReturnValue, class UFortItemDefinition* CallFunc_GetItemDefinitionBP_ReturnValue, bool CallFunc_WouldExceedMaxStackSize_ReturnValue)
{
