...
public:
	...
	struct FFortErrorInfo                        ErrorInfo;                                         // 0x228(0x70)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FString                                ErrorUrlBase;                                      // 0x298(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, HasGetValueTypeHash)
	class FText                                  DebugMessage;                                      // 0x2A8(0x18)(Edit, BlueprintVisible, ExposeOnSpawn)
	bool                                         bIsDebugMode;                                      // 0x2C0(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn)
