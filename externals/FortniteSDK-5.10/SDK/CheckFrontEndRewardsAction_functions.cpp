...
void ACheckFrontEndRewardsAction_C::PopulateNewGiftBoxes(class UFortMcpContext* CallFunc_GetContext_ReturnValue, bool CallFunc_IsValid_ReturnValue, class UFortGiftBoxItem* CallFunc_GetNextGiftBox_ReturnValue, bool CallFunc_IsValid_ReturnValue1)
{
