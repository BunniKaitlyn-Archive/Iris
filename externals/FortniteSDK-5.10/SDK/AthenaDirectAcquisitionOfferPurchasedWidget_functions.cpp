...
{
	static auto Func = Class->GetFunction("AthenaDirectAcquisitionOfferPurchasedWidget_C", "GetWidgetForFramingViewedItem");

	Params::UAthenaDirectAcquisitionOfferPurchasedWidget_C_GetWidgetForFramingViewedItem_Params Parms;
