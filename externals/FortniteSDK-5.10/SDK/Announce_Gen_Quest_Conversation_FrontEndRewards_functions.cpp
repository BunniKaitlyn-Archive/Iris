...
{
	static auto Func = Class->GetFunction("Announce_Gen_Quest_Conversation_FrontEndRewards_C", "UserConstructionScript");

	Params::AAnnounce_Gen_Quest_Conversation_FrontEndRewards_C_UserConstructionScript_Params Parms;
