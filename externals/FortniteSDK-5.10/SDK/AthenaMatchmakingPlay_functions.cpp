...
void UAthenaMatchmakingPlay_C::PlaylistChanged(struct FPlaylistFrontEndData& NewPlaylist)
{
...
// bool                               bHideFillOption                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UAthenaMatchmakingPlay_C::SetSquadFillText(bool InCurrentSquadFill, bool bHideFillOption)
{
	...
	Parms.bHideFillOption = bHideFillOption;
...
// bool                               K2Node_Event_bHideFillOption                                     (ZeroConstructor, IsPlainOldData, NoDestructor)
...
void UAthenaMatchmakingPlay_C::ExecuteUbergraph_AthenaMatchmakingPlay(int32 EntryPoint, class UCommonButton* K2Node_ComponentBoundEvent_Button1, class UIconTextButton_C* K2Node_DynamicCast_AsIcon_Text_Button, bool K2Node_DynamicCast_bSuccess, class UIconTextButton_C* K2Node_DynamicCast_AsIcon_Text_Button1, bool K2Node_DynamicCast_bSuccess1, bool K2Node_Event_bShowPlayButton, class FText K2Node_Event_PlayButtonText, class FText K2Node_Event_CancelButtonText, const struct FPlaylistFrontEndData& K2Node_Event_NewPlaylist, class UCommonButton* K2Node_ComponentBoundEvent_Button, bool K2Node_Event_InCurrentSquadFill, bool K2Node_Event_bHideFillOption, class UCommonButton* K2Node_ComponentBoundEvent_Button2)
{
	...
	Parms.K2Node_Event_bHideFillOption = K2Node_Event_bHideFillOption;
