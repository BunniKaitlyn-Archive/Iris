...
struct UGC_Ninja_MantisLeap_ActivationFX_C_OnExecute_Params
{
public:
	...
	class UParticleSystemComponent*              CallFunc_SpawnEmitterAttached_ReturnValue1;        // 0x100(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
