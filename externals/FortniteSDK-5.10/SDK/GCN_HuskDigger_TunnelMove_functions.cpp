...
{
	static auto Func = Class->GetFunction("GCN_HuskDigger_TunnelMove_C", "UserConstructionScript");

	Params::AGCN_HuskDigger_TunnelMove_C_UserConstructionScript_Params Parms;
