...
public:
	...
	float                                        DecalSize;                                         // 0x910(0x4)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_4796[0x4];                                     
	class UAthenaSprayItemDefinition*            MySpray;                                           // 0x918(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        DecalTraceDistance;                                // 0x920(0x4)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_4797[0x4];                                     
	TSoftObjectPtr<class UAnimMontage>           DefaultSprayMontage_M;                             // 0x928(0x28)(Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
	TSoftObjectPtr<class UAnimMontage>           DefaultSprayMontage_F;                             // 0x950(0x28)(Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
