...
void UItemTransformConfirmationModal_C::Cleanup_Confirmation_Widget(UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UFortMcpContext* CallFunc_GetContext_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1, class UFortMcpContext* CallFunc_GetContext_ReturnValue1, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue)
{
	static auto Func = Class->GetFunction("ItemTransformConfirmationModal_C", "Cleanup Confirmation Widget");

	Params::UItemTransformConfirmationModal_C_Cleanup_Confirmation_Widget_Params Parms;
...
void UItemTransformConfirmationModal_C::Setup_Transform_MCP_Binds(UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1, class UFortMcpContext* CallFunc_GetContext_ReturnValue, class UFortMcpContext* CallFunc_GetContext_ReturnValue1)
{
	static auto Func = Class->GetFunction("ItemTransformConfirmationModal_C", "Setup Transform MCP Binds");

	Params::UItemTransformConfirmationModal_C_Setup_Transform_MCP_Binds_Params Parms;
	Parms.K2Node_CreateDelegate_OutputDelegate = K2Node_CreateDelegate_OutputDelegate;
	Parms.K2Node_CreateDelegate_OutputDelegate1 = K2Node_CreateDelegate_OutputDelegate1;
	Parms.CallFunc_GetContext_ReturnValue = CallFunc_GetContext_ReturnValue;
	Parms.CallFunc_GetContext_ReturnValue1 = CallFunc_GetContext_ReturnValue1;
...
{
	static auto Func = Class->GetFunction("ItemTransformConfirmationModal_C", "PreConstruct");

	Params::UItemTransformConfirmationModal_C_PreConstruct_Params Parms;
...
{
	static auto Func = Class->GetFunction("ItemTransformConfirmationModal_C", "Handle Transform Succeeded");

	Params::UItemTransformConfirmationModal_C_Handle_Transform_Succeeded_Params Parms;
	Parms.TransmoggedItems = TransmoggedItems;
	Parms.RecycledItems = RecycledItems;
...
{
	static auto Func = Class->GetFunction("ItemTransformConfirmationModal_C", "Handle Transform Failed");

	Params::UItemTransformConfirmationModal_C_Handle_Transform_Failed_Params Parms;
...
void UItemTransformConfirmationModal_C::ExecuteUbergraph_ItemTransformConfirmationModal(int32 EntryPoint, class UCommonButton* K2Node_ComponentBoundEvent_Button1, class UCommonButton* K2Node_ComponentBoundEvent_Button, class UFortUINavigationManager* CallFunc_GetUINavigationManager_ReturnValue, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue, bool K2Node_Event_IsDesignTime, TArray<struct FFortItemInstanceQuantityPair>& K2Node_CustomEvent_TransmoggedItems, TArray<struct FFortItemInstanceQuantityPair>& K2Node_CustomEvent_RecycledItems, class UMaterialInstanceDynamic* CallFunc_GetDynamicMaterial_ReturnValue, class FText K2Node_CustomEvent_ErrorMessage)
{
	...
	Parms.K2Node_CustomEvent_TransmoggedItems = K2Node_CustomEvent_TransmoggedItems;
	Parms.K2Node_CustomEvent_RecycledItems = K2Node_CustomEvent_RecycledItems;
