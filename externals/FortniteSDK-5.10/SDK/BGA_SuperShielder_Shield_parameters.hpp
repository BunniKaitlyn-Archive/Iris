...
public:
	...
	float                                        K2Node_Event_Damage2;                              // 0x4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTagContainer                 K2Node_Event_DamageTags2;                          // 0x8(0x20)(ConstParm)
	struct FVector                               K2Node_Event_Momentum2;                            // 0x28(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_2F6F[0x4];                                     
	struct FHitResult                            K2Node_Event_HitInfo2;                             // 0x38(0x88)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	class AFortPawn*                             K2Node_Event_InstigatedBy2;                        // 0xC0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AActor*                                K2Node_Event_DamageCauser2;                        // 0xC8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGameplayEffectContextHandle          K2Node_Event_EffectContext2;                       // 0xD0(0x18)()
	float                                        K2Node_Event_Damage1;                              // 0xE8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_2F70[0x4];                                     
	struct FGameplayTagContainer                 K2Node_Event_DamageTags1;                          // 0xF0(0x20)(ConstParm)
	struct FVector                               K2Node_Event_Momentum1;                            // 0x110(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_2F71[0x4];                                     
	struct FHitResult                            K2Node_Event_HitInfo1;                             // 0x120(0x88)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	class AController*                           K2Node_Event_InstigatedBy1;                        // 0x1A8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AActor*                                K2Node_Event_DamageCauser1;                        // 0x1B0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGameplayEffectContextHandle          K2Node_Event_EffectContext1;                       // 0x1B8(0x18)()
	...
	struct FVector                               K2Node_Event_Momentum;                             // 0x278(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_2F75[0x4];                                     
	struct FHitResult                            K2Node_Event_HitInfo;                              // 0x288(0x88)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	struct FGameplayEffectContextHandle          K2Node_Event_EffectContext;                        // 0x320(0x18)()
	struct FRotator                              CallFunc_MakeRotFromX_ReturnValue;                 // 0x338(0xC)(IsPlainOldData, NoDestructor)
	uint8                                        Pad_2F76[0x4];                                     
	...
	class AShielderPawn_C*                       K2Node_DynamicCast_AsShielder_Pawn;                // 0x350(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0x358(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_2F77[0x7];                                     
	class UGameUserSettings*                     CallFunc_GetGameUserSettings_ReturnValue;          // 0x360(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_GetVisualEffectQuality_ReturnValue;       // 0x368(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_SwitchInteger_CmpSuccess;                   // 0x36C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_2F78[0x3];                                     
	float                                        CallFunc_GetGameTimeInSeconds_ReturnValue;         // 0x370(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_2F79[0x4];                                     
