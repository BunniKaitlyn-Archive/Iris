...
void UBacchusControlsHelp_C::Handle_Close(class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue)
{
	static auto Func = Class->GetFunction("BacchusControlsHelp_C", "Handle Close");

	Params::UBacchusControlsHelp_C_Handle_Close_Params Parms;
...
{
	static auto Func = Class->GetFunction("BacchusControlsHelp_C", "Construct");

	Params::UBacchusControlsHelp_C_Construct_Params Parms;
...
{
	static auto Func = Class->GetFunction("BacchusControlsHelp_C", "BndEvt__ButtonCombat_K2Node_ComponentBoundEvent_113_CommonButtonClicked__DelegateSignature");

	Params::UBacchusControlsHelp_C_BndEvt__ButtonCombat_K2Node_ComponentBoundEvent_113_CommonButtonClicked__DelegateSignature_Params Parms;
	Parms.Button = Button;
...
{
	static auto Func = Class->GetFunction("BacchusControlsHelp_C", "BndEvt__PanelButton_K2Node_ComponentBoundEvent_29_CommonButtonClicked__DelegateSignature");

	Params::UBacchusControlsHelp_C_BndEvt__PanelButton_K2Node_ComponentBoundEvent_29_CommonButtonClicked__DelegateSignature_Params Parms;
	Parms.Button = Button;
...
{
	static auto Func = Class->GetFunction("BacchusControlsHelp_C", "Update");

	Params::UBacchusControlsHelp_C_Update_Params Parms;
...
{
	static auto Func = Class->GetFunction("BacchusControlsHelp_C", "OnActivated");

	Params::UBacchusControlsHelp_C_OnActivated_Params Parms;
