...
{
	static auto Func = Class->GetFunction("Results_NameplateWidget_C", "Outro");
...
{
	static auto Func = Class->GetFunction("Results_NameplateWidget_C", "Intro");

	Params::UResults_NameplateWidget_C_Intro_Params Parms;
...
{
	static auto Func = Class->GetFunction("Results_NameplateWidget_C", "Initialize");
...
{
	static auto Func = Class->GetFunction("Results_NameplateWidget_C", "BndEvt__Anim_Intro_K2Node_ComponentBoundEvent_97_OnWidgetAnimationPlaybackStatusChanged__DelegateSignature");

	Params::UResults_NameplateWidget_C_BndEvt__Anim_Intro_K2Node_ComponentBoundEvent_97_OnWidgetAnimationPlaybackStatusChanged__DelegateSignature_Params Parms;
...
{
	static auto Func = Class->GetFunction("Results_NameplateWidget_C", "BndEvt__Anim_Outro_K2Node_ComponentBoundEvent_121_OnWidgetAnimationPlaybackStatusChanged__DelegateSignature");

	Params::UResults_NameplateWidget_C_BndEvt__Anim_Outro_K2Node_ComponentBoundEvent_121_OnWidgetAnimationPlaybackStatusChanged__DelegateSignature_Params Parms;
...
{
	static auto Func = Class->GetFunction("Results_NameplateWidget_C", "Construct");

	Params::UResults_NameplateWidget_C_Construct_Params Parms;
...
{
	static auto Func = Class->GetFunction("Results_NameplateWidget_C", "ExecuteUbergraph_Results_NameplateWidget");
...
{
	static auto Func = Class->GetFunction("Results_NameplateWidget_C", "IntroComplete__DelegateSignature");

	Params::UResults_NameplateWidget_C_IntroComplete__DelegateSignature_Params Parms;
