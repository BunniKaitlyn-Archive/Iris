...
public:
	...
	class UPlayerBannedModal_C*                  BannedModal;                                       // 0x398(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FMcpBanInfo                           CurrBanInfo;                                       // 0x3A0(0x30)(Edit, BlueprintVisible, DisableEditOnInstance)
