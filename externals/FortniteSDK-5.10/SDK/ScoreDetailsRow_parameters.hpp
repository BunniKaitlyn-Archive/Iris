...
public:
	...
	bool                                         CallFunc_NotEqual_IntInt_ReturnValue2;             // 0x2A(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_519F[0x1];                                     
	...
	float                                        CallFunc_Conv_IntToFloat_ReturnValue2;             // 0x34(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_NotEqual_IntInt_ReturnValue3;             // 0x38(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_51A0[0x3];                                     
	float                                        CallFunc_Conv_IntToFloat_ReturnValue3;             // 0x3C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
