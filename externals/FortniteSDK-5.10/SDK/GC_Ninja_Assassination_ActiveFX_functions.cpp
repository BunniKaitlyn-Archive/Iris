...
{
	static auto Func = Class->GetFunction("GC_Ninja_Assassination_ActiveFX_C", "UserConstructionScript");

	Params::AGC_Ninja_Assassination_ActiveFX_C_UserConstructionScript_Params Parms;
