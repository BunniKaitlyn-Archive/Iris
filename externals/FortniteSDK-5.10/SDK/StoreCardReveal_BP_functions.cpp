...
void AStoreCardReveal_BP_C::SetText_CCB(bool Hide, enum class EFortRarity CCB_Rarity, class FText CCB_Text, bool Temp_bool_Variable, bool Temp_bool_Variable1, bool Temp_bool_Variable2, class UUserWidget* CallFunc_GetUserWidgetObject_ReturnValue, bool K2Node_Select_Default, class UChoiceCardName_C* K2Node_DynamicCast_AsChoice_Card_Name, bool K2Node_DynamicCast_bSuccess, class UFortStoreContext* CallFunc_GetContext_ReturnValue, const struct FCard& CallFunc_GetCard_ResultOut, bool CallFunc_GetCard_ReturnValue, enum class EFortRarity CallFunc_GetRarity_ReturnValue, class UFortCardPackItem* K2Node_DynamicCast_AsFort_Card_Pack_Item, bool K2Node_DynamicCast_bSuccess1, TArray<class UFortAccountItemDefinition*>& CallFunc_GetChoices_Choices, class UFortAccountItemDefinition* CallFunc_Array_Get_Item, class FText CallFunc_GetDisplayName_ReturnValue)
{
