...
struct AFortnitePartyHeroSelect_Camera_C_UserConstructionScript_Params
{
public:
};
...
public:
	...
	uint8                                        Pad_560F[0x4];                                     
	struct FKey                                  K2Node_InputKeyEvent_Key2;                         // 0x8(0x18)(HasGetValueTypeHash)
	struct FKey                                  K2Node_InputKeyEvent_Key1;                         // 0x20(0x18)(HasGetValueTypeHash)
	...
	struct FKey                                  K2Node_InputKeyEvent_Key3;                         // 0x70(0x18)(HasGetValueTypeHash)
	float                                        K2Node_Event_DeltaSeconds;                         // 0x88(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_5610[0x4];                                     
	class APlayerController*                     CallFunc_GetPlayerController_ReturnValue1;         // 0x90(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_5611[0x3];                                     
	struct FRotator                              CallFunc_K2_GetActorRotation_ReturnValue;          // 0xA8(0xC)(IsPlainOldData, NoDestructor)
	...
	struct FRotator                              CallFunc_MakeRotator_ReturnValue;                  // 0xC4(0xC)(IsPlainOldData, NoDestructor)
	struct FKey                                  Temp_struct_Variable1;                             // 0xD0(0x18)(HasGetValueTypeHash)
	...
	class APlayerController*                     CallFunc_GetPlayerController_ReturnValue2;         // 0x198(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
