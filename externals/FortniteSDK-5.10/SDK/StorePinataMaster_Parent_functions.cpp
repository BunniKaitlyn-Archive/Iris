...
{
	static auto Func = Class->GetFunction("StorePinataMaster_Parent_C", "UserConstructionScript");

	Params::AStorePinataMaster_Parent_C_UserConstructionScript_Params Parms;
