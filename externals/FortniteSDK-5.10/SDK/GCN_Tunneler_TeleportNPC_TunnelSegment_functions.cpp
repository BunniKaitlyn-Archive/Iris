...
{
	static auto Func = Class->GetFunction("GCN_Tunneler_TeleportNPC_TunnelSegment_C", "UserConstructionScript");

	Params::AGCN_Tunneler_TeleportNPC_TunnelSegment_C_UserConstructionScript_Params Parms;
...
void AGCN_Tunneler_TeleportNPC_TunnelSegment_C::K2_HandleGameplayCue(class AActor* MyTarget, enum class EGameplayCueEvent EventType, struct FGameplayCueParameters& Parameters)
{
	static auto Func = Class->GetFunction("GCN_Tunneler_TeleportNPC_TunnelSegment_C", "K2_HandleGameplayCue");

	Params::AGCN_Tunneler_TeleportNPC_TunnelSegment_C_K2_HandleGameplayCue_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCN_Tunneler_TeleportNPC_TunnelSegment_C", "ExecuteUbergraph_GCN_Tunneler_TeleportNPC_TunnelSegment");

	Params::AGCN_Tunneler_TeleportNPC_TunnelSegment_C_ExecuteUbergraph_GCN_Tunneler_TeleportNPC_TunnelSegment_Params Parms;
