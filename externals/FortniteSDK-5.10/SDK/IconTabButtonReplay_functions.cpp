...
{
	static auto Func = Class->GetFunction("IconTabButtonReplay_C", "BP_OnSelected");

	Params::UIconTabButtonReplay_C_BP_OnSelected_Params Parms;
...
{
	static auto Func = Class->GetFunction("IconTabButtonReplay_C", "BP_OnDeselected");

	Params::UIconTabButtonReplay_C_BP_OnDeselected_Params Parms;
...
{
	static auto Func = Class->GetFunction("IconTabButtonReplay_C", "BP_OnHovered");

	Params::UIconTabButtonReplay_C_BP_OnHovered_Params Parms;
...
{
	static auto Func = Class->GetFunction("IconTabButtonReplay_C", "BP_OnUnhovered");

	Params::UIconTabButtonReplay_C_BP_OnUnhovered_Params Parms;
...
{
	static auto Func = Class->GetFunction("IconTabButtonReplay_C", "BP_OnEnabled");

	Params::UIconTabButtonReplay_C_BP_OnEnabled_Params Parms;
...
{
	static auto Func = Class->GetFunction("IconTabButtonReplay_C", "BP_OnDisabled");

	Params::UIconTabButtonReplay_C_BP_OnDisabled_Params Parms;
