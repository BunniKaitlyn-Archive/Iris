...
public:
	...
	uint8                                        Pad_4039[0x4];                                     
	class UVerticalBoxSlot*                      CallFunc_AddChildToVerticalBox_ReturnValue;        // 0x228(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	uint8                                        Pad_4044[0x3];                                     
	UDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate3;             // 0x270(0x10)(ZeroConstructor, NoDestructor)
};
