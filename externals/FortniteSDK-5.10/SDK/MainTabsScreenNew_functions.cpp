...
void UMainTabsScreenNew_C::CheckDisplayCriteria(enum class EStoreOfferCosts InCustomStoreOfferCost, const struct FCardPackOffer& InCardPackOffer, bool* bPassedDisplayCriteria, int32 CurrencyBalance, bool K2Node_SwitchEnum_CmpSuccess, bool CallFunc_GreaterEqual_IntInt_ReturnValue, class UFortMcpContext* CallFunc_GetContext_ReturnValue, class UFortMcpContext* CallFunc_GetContext_ReturnValue1, const struct FFortPrivateAccountInfo& CallFunc_GetLocalAccountInfo_Result, class UFortAccountItem* CallFunc_GetAccountItemWithDefinition_ReturnValue, bool CallFunc_IsValid_ReturnValue, int32 CallFunc_GetNumInStack_ReturnValue)
{
	static auto Func = Class->GetFunction("MainTabsScreenNew_C", "CheckDisplayCriteria");

	Params::UMainTabsScreenNew_C_CheckDisplayCriteria_Params Parms;
...
void UMainTabsScreenNew_C::GetCustomStoreOfferCost(const struct FCardPackOffer& InCardPackOffer, enum class EStoreOfferCosts* OutCustomStoreOfferCost, enum class EStoreOfferCosts CustomStoreOfferCost, bool CallFunc_EqualEqual_ObjectObject_ReturnValue, bool CallFunc_EqualEqual_ObjectObject_ReturnValue1, bool CallFunc_EqualEqual_ObjectObject_ReturnValue2, bool CallFunc_EqualEqual_ObjectObject_ReturnValue3, bool CallFunc_Greater_IntInt_ReturnValue)
{
	static auto Func = Class->GetFunction("MainTabsScreenNew_C", "GetCustomStoreOfferCost");

	Params::UMainTabsScreenNew_C_GetCustomStoreOfferCost_Params Parms;
	Parms.InCardPackOffer = InCardPackOffer;
...
// struct FCardPackOffer              CallFunc_CheckHighestPriorityOffer_outPriorityOffer1             ()
// bool                               CallFunc_CheckHighestPriorityOffer_FoundOffer1                   (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_GetMetaBoolOnOffer_ReturnValue                          (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_GetMetaBoolOnOffer_ReturnValue1                         (ZeroConstructor, IsPlainOldData, NoDestructor)
...
void UMainTabsScreenNew_C::Get_Valid_Offers(TArray<struct FCardPackOffer>* Offers, const struct FCardPackOffer& TempOffer, const TArray<struct FCardPackOffer>& UpgradeOffers, const TArray<struct FCardPackOffer>& SharedDisplayOffers, const TArray<struct FCardPackOffer>& StandardOffers, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, const struct FCardPackOffer& CallFunc_CheckHighestPriorityOffer_outPriorityOffer, bool CallFunc_CheckHighestPriorityOffer_FoundOffer, const struct FCardPackOffer& CallFunc_CheckHighestPriorityOffer_outPriorityOffer1, bool CallFunc_CheckHighestPriorityOffer_FoundOffer1, bool CallFunc_GetMetaBoolOnOffer_ReturnValue, bool CallFunc_GetMetaBoolOnOffer_ReturnValue1, int32 CallFunc_Array_Add_ReturnValue, int32 CallFunc_Array_Add_ReturnValue1, class UFortStoreContext* CallFunc_GetContext_ReturnValue, int32 CallFunc_Array_Add_ReturnValue2, int32 CallFunc_Array_Length_ReturnValue, const struct FCardPackOffer& CallFunc_Array_Get_Item, bool CallFunc_Less_IntInt_ReturnValue)
{
	...
	Parms.CallFunc_CheckHighestPriorityOffer_outPriorityOffer1 = CallFunc_CheckHighestPriorityOffer_outPriorityOffer1;
	Parms.CallFunc_CheckHighestPriorityOffer_FoundOffer1 = CallFunc_CheckHighestPriorityOffer_FoundOffer1;
	Parms.CallFunc_GetMetaBoolOnOffer_ReturnValue = CallFunc_GetMetaBoolOnOffer_ReturnValue;
	Parms.CallFunc_GetMetaBoolOnOffer_ReturnValue1 = CallFunc_GetMetaBoolOnOffer_ReturnValue1;
...
// bool                               CallFunc_HasGameplayTagContainer_ReturnValue1                    (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_BooleanOR_ReturnValue                                   (ZeroConstructor, IsPlainOldData, NoDestructor)

bool UMainTabsScreenNew_C::Is_Transform_Feature_Unlocked(class UFortInventoryContext* CallFunc_GetContext_ReturnValue, bool CallFunc_HasGameplayTagContainer_ReturnValue, bool CallFunc_HasGameplayTagContainer_ReturnValue1, bool CallFunc_BooleanOR_ReturnValue)
{
	static auto Func = Class->GetFunction("MainTabsScreenNew_C", "Is Transform Feature Unlocked");

	Params::UMainTabsScreenNew_C_Is_Transform_Feature_Unlocked_Params Parms;
	Parms.CallFunc_GetContext_ReturnValue = CallFunc_GetContext_ReturnValue;
	Parms.CallFunc_HasGameplayTagContainer_ReturnValue = CallFunc_HasGameplayTagContainer_ReturnValue;
	Parms.CallFunc_HasGameplayTagContainer_ReturnValue1 = CallFunc_HasGameplayTagContainer_ReturnValue1;
...
void UMainTabsScreenNew_C::HandleCardPackStore(class FName TabId, bool CallFunc_EqualEqual_NameName_ReturnValue, bool CallFunc_EqualEqual_NameName_ReturnValue1)
{
	static auto Func = Class->GetFunction("MainTabsScreenNew_C", "HandleCardPackStore");

	Params::UMainTabsScreenNew_C_HandleCardPackStore_Params Parms;
	Parms.TabId = TabId;
...
{
	static auto Func = Class->GetFunction("MainTabsScreenNew_C", "HandleMtxStore");

	Params::UMainTabsScreenNew_C_HandleMtxStore_Params Parms;
	Parms.Tab_Id = Tab_Id;
...
void UMainTabsScreenNew_C::Handle_Unclaimed_Resources_Updated(bool CallFunc_Determine_Unclaimed_Resources_at_Threshold_Result)
{
	static auto Func = Class->GetFunction("MainTabsScreenNew_C", "Handle Unclaimed Resources Updated");

	Params::UMainTabsScreenNew_C_Handle_Unclaimed_Resources_Updated_Params Parms;
...
void UMainTabsScreenNew_C::Toggle_Unclaimed_Research_Timer(bool Enable, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue)
{
	static auto Func = Class->GetFunction("MainTabsScreenNew_C", "Toggle Unclaimed Research Timer");

	Params::UMainTabsScreenNew_C_Toggle_Unclaimed_Research_Timer_Params Parms;
	Parms.Enable = Enable;
...
void UMainTabsScreenNew_C::Get_FortPC(class AFortPlayerController** FortPC, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class AFortPlayerController* K2Node_DynamicCast_AsFort_Player_Controller, bool K2Node_DynamicCast_bSuccess)
{
	static auto Func = Class->GetFunction("MainTabsScreenNew_C", "Get FortPC");

	Params::UMainTabsScreenNew_C_Get_FortPC_Params Parms;
...
void UMainTabsScreenNew_C::Update_Armory_Tab_Button_Bang(class FName Tab, bool InventoryUnseen, class FName CurrentTabId, bool TransformKeyUnseen, bool CallFunc_EqualEqual_NameName_ReturnValue, bool CallFunc_EqualEqual_NameName_ReturnValue1, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_Are_Any_Inventory_Items_Unseen_Unseen, bool CallFunc_Are_Any_Transform_Keys_Unseen_Unseen, bool CallFunc_BooleanOR_ReturnValue1, class UHorizontalTabList_C* K2Node_DynamicCast_AsHorizontal_Tab_List, bool K2Node_DynamicCast_bSuccess, class UCommonButton* CallFunc_Get_Tab_From_Id_ReturnValue, class UMainTabIconButton_C* K2Node_DynamicCast_AsMain_Tab_Icon_Button, bool K2Node_DynamicCast_bSuccess1)
{
	static auto Func = Class->GetFunction("MainTabsScreenNew_C", "Update Armory Tab Button Bang");

	Params::UMainTabsScreenNew_C_Update_Armory_Tab_Button_Bang_Params Parms;
	Parms.Tab = Tab;
...
void UMainTabsScreenNew_C::Update_Quest_Tab_Button_Bang(class FName Tab, int32 Count, bool IsClaimedVisibleToUsers, bool IsVisibleToUsers, bool HasNotBeenSeen, bool IsMainQuest, class UFortQuestManager* QuestManager, class FName CurrentTabId, class AFortPlayerController* FortPC, bool QuestsUnseen, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, bool CallFunc_EqualEqual_NameName_ReturnValue, class UFortQuestManager* CallFunc_GetQuestManager_ReturnValue, bool CallFunc_EqualEqual_NameName_ReturnValue1, bool CallFunc_IsValid_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, int32 CallFunc_GetUnseenQuestCount_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, class UHorizontalTabList_C* K2Node_DynamicCast_AsHorizontal_Tab_List, bool K2Node_DynamicCast_bSuccess, class UCommonButton* CallFunc_Get_Tab_From_Id_ReturnValue, class UQuestsCountIconTabButton_C* K2Node_DynamicCast_AsQuests_Count_Icon_Tab_Button, bool K2Node_DynamicCast_bSuccess1)
{
	static auto Func = Class->GetFunction("MainTabsScreenNew_C", "Update Quest Tab Button Bang");

	Params::UMainTabsScreenNew_C_Update_Quest_Tab_Button_Bang_Params Parms;
	Parms.Tab = Tab;
	Parms.Count = Count;
...
{
	static auto Func = Class->GetFunction("MainTabsScreenNew_C", "Update Tab Button Bangs");

	Params::UMainTabsScreenNew_C_Update_Tab_Button_Bangs_Params Parms;
	Parms.InTab = InTab;
...
// bool                               CallFunc_Greater_IntInt_ReturnValue                              (ZeroConstructor, IsPlainOldData, NoDestructor)
// class APlayerController*           CallFunc_GetOwningPlayer_ReturnValue                             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_AreAnyHomebaseNodeItemsUnseenForSquadType_ReturnValue1  (ZeroConstructor, IsPlainOldData, NoDestructor)
// class AFortPlayerController*       K2Node_DynamicCast_AsFort_Player_Controller                      (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               K2Node_DynamicCast_bSuccess                                      (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_BooleanOR_ReturnValue1                                  (ZeroConstructor, IsPlainOldData, NoDestructor)
// class UHorizontalTabList_C*        K2Node_DynamicCast_AsHorizontal_Tab_List                         (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UMainTabsScreenNew_C::Update_Squad_Tab_Button_Bang(class FName Tab, class FName CurrentTabId, class FName EmptyTabId, bool ExpeditionSquadUnseen, class AFortPlayerController* FortPC, bool DefenderSquadUnseen, bool AttributeSquadUnseen, bool CallFunc_EqualEqual_NameName_ReturnValue, bool CallFunc_EqualEqual_NameName_ReturnValue1, bool CallFunc_BooleanOR_ReturnValue, int32 CallFunc_TotalUnseenExpeditionsForTab_ReturnValue, bool CallFunc_AreAnyHomebaseNodeItemsUnseenForSquadType_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, bool CallFunc_AreAnyHomebaseNodeItemsUnseenForSquadType_ReturnValue1, class AFortPlayerController* K2Node_DynamicCast_AsFort_Player_Controller, bool K2Node_DynamicCast_bSuccess, bool CallFunc_BooleanOR_ReturnValue1, class UHorizontalTabList_C* K2Node_DynamicCast_AsHorizontal_Tab_List, bool K2Node_DynamicCast_bSuccess1, bool CallFunc_BooleanOR_ReturnValue2, class UCommonButton* CallFunc_Get_Tab_From_Id_ReturnValue, class UMainTabIconButton_C* K2Node_DynamicCast_AsMain_Tab_Icon_Button, bool K2Node_DynamicCast_bSuccess2)
{
	...
	Parms.CallFunc_Greater_IntInt_ReturnValue = CallFunc_Greater_IntInt_ReturnValue;
	Parms.CallFunc_GetOwningPlayer_ReturnValue = CallFunc_GetOwningPlayer_ReturnValue;
	Parms.CallFunc_AreAnyHomebaseNodeItemsUnseenForSquadType_ReturnValue1 = CallFunc_AreAnyHomebaseNodeItemsUnseenForSquadType_ReturnValue1;
	Parms.K2Node_DynamicCast_AsFort_Player_Controller = K2Node_DynamicCast_AsFort_Player_Controller;
	Parms.K2Node_DynamicCast_bSuccess = K2Node_DynamicCast_bSuccess;
	Parms.CallFunc_BooleanOR_ReturnValue1 = CallFunc_BooleanOR_ReturnValue1;
	Parms.K2Node_DynamicCast_AsHorizontal_Tab_List = K2Node_DynamicCast_AsHorizontal_Tab_List;
...
void UMainTabsScreenNew_C::HandleTabSelected(class FName TabName, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue, class FName CallFunc_GetActiveTab_ReturnValue)
{
	static auto Func = Class->GetFunction("MainTabsScreenNew_C", "HandleTabSelected");

	Params::UMainTabsScreenNew_C_HandleTabSelected_Params Parms;
...
{
	static auto Func = Class->GetFunction("MainTabsScreenNew_C", "OnActivated");

	Params::UMainTabsScreenNew_C_OnActivated_Params Parms;
...
{
	static auto Func = Class->GetFunction("MainTabsScreenNew_C", "CustomEvent");

	Params::UMainTabsScreenNew_C_CustomEvent_Params Parms;
	Parms.TabId = TabId;
	Parms.TabButton = TabButton;
...
{
	static auto Func = Class->GetFunction("MainTabsScreenNew_C", "Construct");

	Params::UMainTabsScreenNew_C_Construct_Params Parms;
...
{
	static auto Func = Class->GetFunction("MainTabsScreenNew_C", "OnHomebaseInventoryUpdated");

	Params::UMainTabsScreenNew_C_OnHomebaseInventoryUpdated_Params Parms;
...
{
	static auto Func = Class->GetFunction("MainTabsScreenNew_C", "HandleRefreshSkillTreeNodePage");

	Params::UMainTabsScreenNew_C_HandleRefreshSkillTreeNodePage_Params Parms;
...
{
	static auto Func = Class->GetFunction("MainTabsScreenNew_C", "Destruct");

	Params::UMainTabsScreenNew_C_Destruct_Params Parms;
...
{
	static auto Func = Class->GetFunction("MainTabsScreenNew_C", "OnQuestSeen_Event_0");

	Params::UMainTabsScreenNew_C_OnQuestSeen_Event_0_Params Parms;
	Parms.Quest = Quest;
...
{
	static auto Func = Class->GetFunction("MainTabsScreenNew_C", "SquadSlotMarkedAsSeen_Event_0");

	Params::UMainTabsScreenNew_C_SquadSlotMarkedAsSeen_Event_0_Params Parms;
...
{
	static auto Func = Class->GetFunction("MainTabsScreenNew_C", "HandleMainTabSelected");

	Params::UMainTabsScreenNew_C_HandleMainTabSelected_Params Parms;
...
{
	static auto Func = Class->GetFunction("MainTabsScreenNew_C", "HandleMainTabCreated");

	Params::UMainTabsScreenNew_C_HandleMainTabCreated_Params Parms;
	Parms.TabNameID = TabNameID;
	Parms.TabButton = TabButton;
