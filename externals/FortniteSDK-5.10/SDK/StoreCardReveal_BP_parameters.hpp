...
public:
	...
	class FText                                  Temp_text_Variable77;                              // 0xA10(0x18)()
	class FText                                  Temp_text_Variable78;                              // 0xA28(0x18)()
	class FText                                  Temp_text_Variable79;                              // 0xA40(0x18)()
	class FText                                  Temp_text_Variable80;                              // 0xA58(0x18)()
	class FText                                  Temp_text_Variable81;                              // 0xA70(0x18)()
	class FText                                  Temp_text_Variable82;                              // 0xA88(0x18)()
	class FText                                  CallFunc_MakeLiteralText_ReturnValue;              // 0xAA0(0x18)()
	class FText                                  K2Node_Select_Default;                             // 0xAB8(0x18)()
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData4;             // 0xAD0(0x40)(HasGetValueTypeHash)
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData5;             // 0xB10(0x40)(HasGetValueTypeHash)
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData6;             // 0xB50(0x40)(HasGetValueTypeHash)
	TArray<struct FFormatArgumentData>           K2Node_MakeArray_Array;                            // 0xB90(0x10)(ZeroConstructor, ReferenceParm)
	TArray<struct FFormatArgumentData>           K2Node_MakeArray_Array1;                           // 0xBA0(0x10)(ZeroConstructor, ReferenceParm)
	class FText                                  CallFunc_Format_ReturnValue;                       // 0xBB0(0x18)()
	class FText                                  CallFunc_Format_ReturnValue1;                      // 0xBC8(0x18)()
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData7;             // 0xBE0(0x40)(HasGetValueTypeHash)
	TArray<struct FFormatArgumentData>           K2Node_MakeArray_Array2;                           // 0xC20(0x10)(ZeroConstructor, ReferenceParm)
	class FText                                  CallFunc_Format_ReturnValue2;                      // 0xC30(0x18)()
};
