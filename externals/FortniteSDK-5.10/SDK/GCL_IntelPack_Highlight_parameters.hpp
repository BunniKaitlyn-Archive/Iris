...
public:
	...
	uint8                                        Pad_48B4[0x3];                                     
	struct FVector                               CallFunc_Conv_LinearColorToVector_ReturnValue;     // 0x14(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_48B5[0x3];                                     
	struct FVector                               CallFunc_GetComponentBounds_Origin;                // 0x2C(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_GetComponentBounds_BoxExtent;             // 0x38(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               CallFunc_Conv_FloatToVector_ReturnValue;           // 0x4C(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FLinearColor                          CallFunc_Conv_VectorToLinearColor_ReturnValue;     // 0xA8(0x10)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
