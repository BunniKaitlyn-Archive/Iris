...
public:
	...
	struct FRotator                              CallFunc_Conv_VectorToRotator_ReturnValue;         // 0xF4(0xC)(IsPlainOldData, NoDestructor)
	...
	uint8                                        Pad_48BF[0x4];                                     
	struct FHitResult                            CallFunc_K2_SetWorldRotation_SweepHitResult;       // 0x110(0x88)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
};
