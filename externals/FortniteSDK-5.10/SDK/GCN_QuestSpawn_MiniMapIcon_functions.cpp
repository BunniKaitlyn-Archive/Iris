...
{
	static auto Func = Class->GetFunction("GCN_QuestSpawn_MiniMapIcon_C", "UserConstructionScript");

	Params::AGCN_QuestSpawn_MiniMapIcon_C_UserConstructionScript_Params Parms;
