...
{
public:
	int32                                        Base_Delta;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_51AD[0x4];                                     
	class FText                                  Name_Text;                                         // 0x8(0x18)(BlueprintVisible, BlueprintReadOnly, Parm)
	class UScoreMessageNumber_C*                 In_Score_Widget;                                   // 0x20(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
