...
{
	static auto Func = Class->GetFunction("Trap_Floor_Hoverboard_Speed_C", "UserConstructionScript");

	Params::ATrap_Floor_Hoverboard_Speed_C_UserConstructionScript_Params Parms;
