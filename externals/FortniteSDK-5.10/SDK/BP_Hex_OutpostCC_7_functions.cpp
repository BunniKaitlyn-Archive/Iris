...
{
	static auto Func = Class->GetFunction("BP_Hex_OutpostCC_7_C", "UserConstructionScript");

	Params::ABP_Hex_OutpostCC_7_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Hex_OutpostCC_7_C", "ReceiveBeginPlay");

	Params::ABP_Hex_OutpostCC_7_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Hex_OutpostCC_7_C", "ActivateOutpost");

	Params::ABP_Hex_OutpostCC_7_C_ActivateOutpost_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Hex_OutpostCC_7_C", "HandleOnPlayerInfoChanged");
...
{
	static auto Func = Class->GetFunction("BP_Hex_OutpostCC_7_C", "ExecuteUbergraph_BP_Hex_OutpostCC_7");
