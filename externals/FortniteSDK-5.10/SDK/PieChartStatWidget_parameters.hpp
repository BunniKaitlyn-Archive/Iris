...
public:
	...
	TArray<struct FLinearColor>                  K2Node_MakeArray_Array1;                           // 0xD8(0x10)(ZeroConstructor, ReferenceParm)
	struct FLinearColor                          CallFunc_Array_Get_Item1;                          // 0xE8(0x10)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	enum class ECommonNumericType                Temp_byte_Variable1;                               // 0xF9(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3A5D[0x6];                                     
	TArray<class FName>                          K2Node_MakeArray_Array2;                           // 0x100(0x10)(ZeroConstructor, ReferenceParm)
	class FName                                  CallFunc_Array_Get_Item2;                          // 0x110(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	class FText                                  CallFunc_TextToUpper_ReturnValue1;                 // 0x1B0(0x18)()
