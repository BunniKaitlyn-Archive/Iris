...
float AGCL_BoostJumpPack_FuelRegen_C::GetReserveFuel(const struct FGameplayAttribute& ReserveFuelAttribute, bool CallFunc_GetFloatAttribute_bSuccessfullyFoundAttribute, float CallFunc_GetFloatAttribute_ReturnValue, bool CallFunc_IsValid_ReturnValue, float CallFunc_GetSimulatedAttributeValue_ReturnValue)
{
	static auto Func = Class->GetFunction("GCL_BoostJumpPack_FuelRegen_C", "GetReserveFuel");

	Params::AGCL_BoostJumpPack_FuelRegen_C_GetReserveFuel_Params Parms;
...
void AGCL_BoostJumpPack_FuelRegen_C::GetReserveFuelPercent(float* FuelPercent, float CallFunc_GetReserveFuel_ReturnValue, float CallFunc_Divide_FloatFloat_ReturnValue)
{
	static auto Func = Class->GetFunction("GCL_BoostJumpPack_FuelRegen_C", "GetReserveFuelPercent");

	Params::AGCL_BoostJumpPack_FuelRegen_C_GetReserveFuelPercent_Params Parms;
...
float AGCL_BoostJumpPack_FuelRegen_C::GetFuel(const struct FGameplayAttribute& FuelAttribute, bool CallFunc_GetFloatAttribute_bSuccessfullyFoundAttribute, float CallFunc_GetFloatAttribute_ReturnValue, bool CallFunc_IsValid_ReturnValue, float CallFunc_GetSimulatedAttributeValue_ReturnValue)
{
	static auto Func = Class->GetFunction("GCL_BoostJumpPack_FuelRegen_C", "GetFuel");

	Params::AGCL_BoostJumpPack_FuelRegen_C_GetFuel_Params Parms;
...
void AGCL_BoostJumpPack_FuelRegen_C::GetFuelPercent(float* FuelPercent, float CallFunc_GetFuel_ReturnValue, float CallFunc_Divide_FloatFloat_ReturnValue)
{
	static auto Func = Class->GetFunction("GCL_BoostJumpPack_FuelRegen_C", "GetFuelPercent");

	Params::AGCL_BoostJumpPack_FuelRegen_C_GetFuelPercent_Params Parms;
...
bool AGCL_BoostJumpPack_FuelRegen_C::OnRemove(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, bool CallFunc_IsValid_ReturnValue, class USkeletalMeshComponent* CallFunc_GetSkeletalMeshForPartType_ReturnValue)
{
	static auto Func = Class->GetFunction("GCL_BoostJumpPack_FuelRegen_C", "OnRemove");

	Params::AGCL_BoostJumpPack_FuelRegen_C_OnRemove_Params Parms;
...
bool AGCL_BoostJumpPack_FuelRegen_C::OnActive(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, class APlayerPawn_Athena_C* K2Node_DynamicCast_AsPlayer_Pawn_Athena, bool K2Node_DynamicCast_bSuccess, class USkeletalMeshComponent* CallFunc_GetSkeletalMeshForPartType_ReturnValue)
{
	static auto Func = Class->GetFunction("GCL_BoostJumpPack_FuelRegen_C", "OnActive");

	Params::AGCL_BoostJumpPack_FuelRegen_C_OnActive_Params Parms;
	Parms.MyTarget = MyTarget;
	Parms.Parameters = Parameters;
...
{
	static auto Func = Class->GetFunction("GCL_BoostJumpPack_FuelRegen_C", "UserConstructionScript");

	Params::AGCL_BoostJumpPack_FuelRegen_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCL_BoostJumpPack_FuelRegen_C", "ReceiveTick");

	Params::AGCL_BoostJumpPack_FuelRegen_C_ReceiveTick_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCL_BoostJumpPack_FuelRegen_C", "Audio Tick");

	Params::AGCL_BoostJumpPack_FuelRegen_C_Audio_Tick_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCL_BoostJumpPack_FuelRegen_C", "Start Fuel Blink FX");

	Params::AGCL_BoostJumpPack_FuelRegen_C_Start_Fuel_Blink_FX_Params Parms;
