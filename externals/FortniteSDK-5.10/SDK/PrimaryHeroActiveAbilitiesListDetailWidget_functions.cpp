...
{
	static auto Func = Class->GetFunction("PrimaryHeroActiveAbilitiesListDetailWidget_C", "HandlePostDifferentItemToDetailSet");

	Params::UPrimaryHeroActiveAbilitiesListDetailWidget_C_HandlePostDifferentItemToDetailSet_Params Parms;
...
{
	static auto Func = Class->GetFunction("PrimaryHeroActiveAbilitiesListDetailWidget_C", "HandlePostDifferentSquadSlotSetBP");

	Params::UPrimaryHeroActiveAbilitiesListDetailWidget_C_HandlePostDifferentSquadSlotSetBP_Params Parms;
...
{
	static auto Func = Class->GetFunction("PrimaryHeroActiveAbilitiesListDetailWidget_C", "Construct");

	Params::UPrimaryHeroActiveAbilitiesListDetailWidget_C_Construct_Params Parms;
...
// struct FHomebaseSquad              CallFunc_TryGetHomebaseSquadData_OutHomebaseSquad1               ()
...
{
	static auto Func = Class->GetFunction("PrimaryHeroActiveAbilitiesListDetailWidget_C", "ExecuteUbergraph_PrimaryHeroActiveAbilitiesListDetailWidget");
