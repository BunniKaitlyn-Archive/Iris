...
public:
	...
	uint8                                        Pad_4188[0x7];                                     
	struct FGameplayAbilityTargetDataHandle      K2Node_CustomEvent_TargetData1;                    // 0x128(0x20)(ConstParm)
	struct FGameplayTag                          K2Node_CustomEvent_ApplicationTag1;                // 0x148(0x8)(NoDestructor, HasGetValueTypeHash)
	...
	struct FGameplayAbilityTargetDataHandle      Temp_struct_Variable1;                             // 0x190(0x20)()
