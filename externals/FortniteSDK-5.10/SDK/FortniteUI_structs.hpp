...
enum class EFortCollectionBookPopupButtonType : uint8
{
	...
	Purchase                       = 2,
	Back                           = 3,
	EFortCollectionBookPopupButtonType_MAX = 4,
};
...
enum class ESettingType : uint8
{
	...
	ShowFPS                        = 14,
	AllowLowPower                  = 15,
	MouseSensitivityYaw            = 16,
	MouseSensitivityPitch          = 17,
	TouchDragSensitivity           = 18,
	ControllerLookSensitivityYaw   = 19,
	ControllerLookSensitivityPitch = 20,
	MouseTargetingMultiplier       = 21,
	MouseScopedMultiplier          = 22,
	GamepadTargetingMultiplier     = 23,
	GamepadScopedMultiplier        = 24,
	TouchDragTargetingSensitivity  = 25,
	TouchDragScopedSensitivity     = 26,
	TouchVerticalSensitivity       = 27,
	GyroEnabled                    = 28,
	GyroSensitivity                = 29,
	GyroTargetingSensitivity       = 30,
	GyroScopedSensitivity          = 31,
	GyroHarvestingToolSensitivity  = 32,
	SafeZone                       = 33,
	ConsoleUnlockedFPS             = 34,
	RegionHeader                   = 35,
	Language                       = 36,
	InvertAcceptAndBack            = 37,
	Region                         = 38,
	InvertMouse                    = 39,
	ToggleSprint                   = 40,
	SprintByDefault                = 41,
	SprintCancelsReload            = 42,
	TapInteract                    = 43,
	ToggleTargeting                = 44,
	AutoEquipBetterItems           = 45,
	FirstPersonCamera              = 46,
	ForceFeedback                  = 47,
	AimAssist                      = 48,
	EquipFirstBuildingPieceWhenSwappingQuickbars = 49,
	EquipFirstBuildingPieceWhenSwappingQuickbarsAthena = 50,
	ShowHeadAccessories            = 51,
	ShowBackpack                   = 52,
	PeripheralLighting             = 53,
	ShowViewerCount                = 54,
	GamepadAutoRun                 = 55,
	HUDScale                       = 56,
	StreamerMode                   = 57,
	...
	CrossplayPreference            = 60,
	ReplayRecording                = 61,
	ReplayRecordingLargeTeams      = 62,
	UseTapToShoot                  = 63,
	AutoOpenDoors                  = 64,
	AutoPickupWeapons              = 65,
	AutoPickupWeaponsConsolePC     = 66,
	UsePowerSavingMode             = 67,
	ShadowPlayHighlights           = 68,
	ShowGlobalChat                 = 69,
	EditModeAimAssist              = 70,
	GammaValue                     = 71,
	MusicVolume                    = 72,
	SoundFXVolume                  = 73,
	DialogVolume                   = 74,
	...
	VoiceChat                      = 79,
	PushToTalk                     = 80,
	ProximityVoiceChat             = 81,
	VoiceChatInputDevice           = 82,
	VoiceChatOutputDevice          = 83,
	AllowBackgroundAudio           = 84,
	ColorBlindMode                 = 85,
	ColorBlindStrength             = 86,
	IgnoreGamepadInput             = 87,
	VisualizeSoundEffects          = 88,
	VisualizeSoundEffectsHeader    = 89,
	ESettingType_MAX               = 90,
};
