...
public:
	...
	bool                                         CallFunc_BooleanAND_ReturnValue1;                  // 0x37(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
public:
	...
	uint8                                        Pad_39A4[0x4];                                     
	class UCommonButton*                         K2Node_ComponentBoundEvent_Button3;                // 0x8(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_39A5[0x7];                                     
	class UItemInspectScreen_C*                  K2Node_DynamicCast_AsItem_Inspect_Screen1;         // 0x30(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess1;                      // 0x38(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_39A6[0x7];                                     
	class UItemInspectScreen_C*                  K2Node_DynamicCast_AsItem_Inspect_Screen2;         // 0x40(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess2;                      // 0x48(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_39A7[0x7];                                     
	class UItemInspectScreen_C*                  K2Node_DynamicCast_AsItem_Inspect_Screen3;         // 0x50(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UItemInspectScreen_C*                  K2Node_DynamicCast_AsItem_Inspect_Screen4;         // 0x70(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
