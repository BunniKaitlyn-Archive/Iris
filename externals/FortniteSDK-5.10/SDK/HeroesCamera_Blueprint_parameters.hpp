...
public:
	...
	struct FKey                                  K2Node_InputKeyEvent_Key1;                         // 0x38(0x18)(HasGetValueTypeHash)
	struct FKey                                  K2Node_InputKeyEvent_Key;                          // 0x50(0x18)(HasGetValueTypeHash)
	struct FKey                                  Temp_struct_Variable1;                             // 0x68(0x18)(HasGetValueTypeHash)
	...
	struct FKey                                  K2Node_InputKeyEvent_Key3;                         // 0x88(0x18)(HasGetValueTypeHash)
	...
	class APlayerController*                     CallFunc_GetPlayerController_ReturnValue2;         // 0xF8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
