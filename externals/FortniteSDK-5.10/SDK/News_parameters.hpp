...
{
public:
	class FText                                  BodyText;                                          // 0x0(0x18)(BlueprintVisible, BlueprintReadOnly, Parm)
};
...
public:
	...
	uint8                                        Pad_5052[0x7];                                     
	class UNewsEntry_C*                          K2Node_DynamicCast_AsNews_Entry;                   // 0x30(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
{
public:
	class FText                                  InEntryText;                                       // 0x0(0x18)(BlueprintVisible, BlueprintReadOnly, Parm)
	UDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate;              // 0x18(0x10)(ZeroConstructor, NoDestructor)
	class APlayerController*                     CallFunc_GetOwningPlayer_ReturnValue;              // 0x28(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UNewsEntry_C*                          CallFunc_Create_ReturnValue;                       // 0x30(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
