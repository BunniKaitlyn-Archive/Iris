...
// class UWaveModifiersTile_C*        CallFunc_Array_Get_Item                                          (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_Array_IsValidIndex_ReturnValue                          (ZeroConstructor, IsPlainOldData, NoDestructor)
// class UVerticalBoxSlot*            CallFunc_AddChildToVerticalBox_ReturnValue                       (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                              CallFunc_Add_IntInt_ReturnValue                                  (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWaveModifiersWidget_C::PresentNextModifier(int32 Temp_int_Variable, class UWaveModifiersTile_C* CallFunc_Array_Get_Item, bool CallFunc_Array_IsValidIndex_ReturnValue, class UVerticalBoxSlot* CallFunc_AddChildToVerticalBox_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue)
{
	static auto Func = Class->GetFunction("WaveModifiersWidget_C", "PresentNextModifier");
...
// class UWaveModifiersTile_C*        CallFunc_Create_ReturnValue                                      (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
{
	static auto Func = Class->GetFunction("WaveModifiersWidget_C", "OnModifiersAdded");
...
{
	static auto Func = Class->GetFunction("WaveModifiersWidget_C", "OnAllModifiersPresented__DelegateSignature");

	Params::UWaveModifiersWidget_C_OnAllModifiersPresented__DelegateSignature_Params Parms;
