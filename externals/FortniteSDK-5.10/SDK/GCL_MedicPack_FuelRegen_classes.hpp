...
public:
	...
	float                                        FullBlinkTimeline_Blink_E9F43B6D4602FAD63F4CBEB5A2D6506B; // 0x428(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ETimelineDirection                FullBlinkTimeline__Direction_E9F43B6D4602FAD63F4CBEB5A2D6506B; // 0x42C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3D63[0x3];                                     
