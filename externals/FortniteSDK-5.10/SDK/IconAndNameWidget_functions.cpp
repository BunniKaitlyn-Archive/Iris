...
{
	static auto Func = Class->GetFunction("IconAndNameWidget_C", "Set Border Color");
...
{
	static auto Func = Class->GetFunction("IconAndNameWidget_C", "Setup Text");
...
{
	static auto Func = Class->GetFunction("IconAndNameWidget_C", "Setup Border");
...
{
	static auto Func = Class->GetFunction("IconAndNameWidget_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("IconAndNameWidget_C", "ExecuteUbergraph_IconAndNameWidget");
