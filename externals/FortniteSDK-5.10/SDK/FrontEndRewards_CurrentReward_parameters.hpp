...
struct UFrontEndRewards_CurrentReward_C_Reset_Canvas_Panel_Slot_Alignment_and_Anchors_Params
{
public:
	class UCanvasPanelSlot*                      K2Node_DynamicCast_AsCanvas_Panel_Slot;            // 0x0(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UFrontEndRewards_CurrentReward_C_Reset_Reward_Icon_Translation_and_Scale_Params
{
public:
};
...
struct UFrontEndRewards_CurrentReward_C_Play_Open_Animation_Sound_Params
{
public:
...
struct UFrontEndRewards_CurrentReward_C_Play_Pop_Animation_Sound_Params
{
public:
	enum class EFrontEndRewardType               Temp_byte_Variable;                                // 0x0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_46BD[0x7];                                     
...
struct UFrontEndRewards_CurrentReward_C_Play_Drop_Animation_Sound_Params
{
public:
	enum class EFrontEndRewardType               Temp_byte_Variable;                                // 0x0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_46BE[0x7];                                     
...
struct UFrontEndRewards_CurrentReward_C_SkipPopAnimation_Params
{
public:
...
struct UFrontEndRewards_CurrentReward_C_StopBounceAnimation_Params
{
public:
...
struct UFrontEndRewards_CurrentReward_C_PlayFadeOutAnimation_Params
{
public:
	bool                                         CallFunc_IsAnimationPlaying_ReturnValue;           // 0x0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
struct UFrontEndRewards_CurrentReward_C_SkipOpenAnimation_Params
{
public:
...
struct UFrontEndRewards_CurrentReward_C_UpdateFade_Params
{
public:
	float                                        TimePassed;                                        // 0x0(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                        CallFunc_FInterpEaseInOut_ReturnValue;             // 0x18(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0x0 (0x0 - 0x0)
// Function FrontEndRewards_CurrentReward.FrontEndRewards_CurrentReward_C.HandleOpenAnimationFinished
struct UFrontEndRewards_CurrentReward_C_HandleOpenAnimationFinished_Params
{
public:
};
...
struct UFrontEndRewards_CurrentReward_C_HandleDropAnimationFinished_Params
{
public:
};
...
struct UFrontEndRewards_CurrentReward_C_HandlePopAnimationFinished_Params
{
public:
};
...
struct UFrontEndRewards_CurrentReward_C_PlayOpenAnimation_Params
{
public:
	bool                                         CallFunc_IsAnimationPlaying_ReturnValue;           // 0x0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
struct UFrontEndRewards_CurrentReward_C_PlayPopAnimation_Params
{
public:
	bool                                         CallFunc_IsAnimationPlaying_ReturnValue;           // 0x0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
struct UFrontEndRewards_CurrentReward_C_PlayDropAnimation_Params
{
public:
	bool                                         CallFunc_IsAnimationPlaying_ReturnValue;           // 0x0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
struct UFrontEndRewards_CurrentReward_C_Construct_Params
{
public:
};
...
struct UFrontEndRewards_CurrentReward_C_FadeIconToWhite_Params
{
public:
};
...
struct UFrontEndRewards_CurrentReward_C_OnOpenAnimationFinished__DelegateSignature_Params
{
public:
};
...
struct UFrontEndRewards_CurrentReward_C_OnOpenAnimationStarted__DelegateSignature_Params
{
public:
};
...
struct UFrontEndRewards_CurrentReward_C_OnPopAnimationFinished__DelegateSignature_Params
{
public:
};
...
struct UFrontEndRewards_CurrentReward_C_OnDropAnimationFinished__DelegateSignature_Params
{
public:
};
