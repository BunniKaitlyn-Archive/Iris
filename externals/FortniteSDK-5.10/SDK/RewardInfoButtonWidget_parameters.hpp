...
{
public:
	bool                                         bInShowDescription;                                // 0x0(0x1)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
public:
	...
	bool                                         K2Node_Event_bInShowDescription;                   // 0x5(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_4780[0x2];                                     
	int32                                        CallFunc_GetQuantity_ReturnValue;                  // 0x8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_4781[0x4];                                     
	class UFortItem*                             CallFunc_GetItemInstance_ReturnValue;              // 0x10(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                  CallFunc_GetEmptyText_ReturnValue;                 // 0x98(0x18)()
	TArray<struct FFormatArgumentData>           K2Node_MakeArray_Array;                            // 0xB0(0x10)(ZeroConstructor, ReferenceParm)
	bool                                         CallFunc_EqualEqual_TextText_ReturnValue;          // 0xC0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_4783[0x7];                                     
	class FText                                  CallFunc_Format_ReturnValue;                       // 0xC8(0x18)()
	class UFortItem*                             CallFunc_GetItemInstance_ReturnValue1;             // 0xE0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UFortItemDefinition*                   CallFunc_GetItemDefinitionBP_ReturnValue1;         // 0xE8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FText                                  CallFunc_GetDisplayName_ReturnValue1;              // 0xF0(0x18)()
	class FText                                  CallFunc_GetDisplayName_DisplayName;               // 0x108(0x18)()
	enum class ESlateVisibility                  Temp_byte_Variable1;                               // 0x120(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_4784[0x7];                                     
	class FText                                  CallFunc_GetEmptyText_ReturnValue1;                // 0x128(0x18)()
