...
// class UPlayerZoneTeamScoreContributionWidget_C*CallFunc_Create_ReturnValue                                      (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// int32                              CallFunc_Add_IntInt_ReturnValue                                  (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                              CallFunc_Array_Length_ReturnValue                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UPlayerZoneTeamScoreContributionWidget_C*CallFunc_Array_Get_Item                                          (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_Less_IntInt_ReturnValue                                 (ZeroConstructor, IsPlainOldData, NoDestructor)
...
void UZoneScoreWidget_C::ExecuteUbergraph_ZoneScoreWidget(int32 EntryPoint, class UFortHUDContext* CallFunc_GetContext_ReturnValue, bool CallFunc_EqualEqual_FloatFloat_ReturnValue, float CallFunc_Divide_FloatFloat_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, float CallFunc_Subtract_FloatFloat_ReturnValue, const struct FGeometry& K2Node_Event_MyGeometry, float K2Node_Event_InDeltaTime, float CallFunc_Subtract_FloatFloat_ReturnValue1, float CallFunc_FMax_ReturnValue, class UAudioComponent* CallFunc_SpawnSound2D_ReturnValue, class UFortHUDContext* CallFunc_GetContext_ReturnValue1, float CallFunc_GetTimeToDelayEndOfDayZoneWidgetDisplay_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1, const struct FEndOfDayRecap& K2Node_CustomEvent_EndOfDayRecap)
{
	...
	Parms.CallFunc_GetTimeToDelayEndOfDayZoneWidgetDisplay_ReturnValue = CallFunc_GetTimeToDelayEndOfDayZoneWidgetDisplay_ReturnValue;
