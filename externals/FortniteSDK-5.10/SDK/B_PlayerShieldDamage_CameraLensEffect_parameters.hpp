...
struct AB_PlayerShieldDamage_CameraLensEffect_C_UserConstructionScript_Params
{
public:
};
...
public:
	...
	float                                        CallFunc_Subtract_FloatFloat_ReturnValue1;         // 0x10(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
