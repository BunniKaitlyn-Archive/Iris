...
public:
	...
	struct FVector                               Normal;                                            // 0x18(0xC)(Parm, OutParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                              CallFunc_GetBaseAimRotation_ReturnValue;           // 0x24(0xC)(IsPlainOldData, NoDestructor)
	TArray<class AActor*>                        K2Node_MakeArray_Array;                            // 0x30(0x10)(ConstParm, ZeroConstructor, ReferenceParm)
	struct FVector                               CallFunc_GetForwardVector_ReturnValue;             // 0x40(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_478D[0x4];                                     
	...
	struct FVector                               CallFunc_MakeVector_ReturnValue;                   // 0x90(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	class AFortPawn*                             CallFunc_GetActivatingPawn_ReturnValue1;           // 0x30(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_4794[0x2];                                     
	struct FVector                               CallFunc_TargetLineTrace_Location;                 // 0x44(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_TargetLineTrace_Normal;                   // 0x50(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_GetRightVector_ReturnValue;               // 0x5C(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_Subtract_VectorVector_ReturnValue;        // 0x68(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_4795[0x3];                                     
	struct FRotator                              CallFunc_MakeRotationFromAxes_ReturnValue;         // 0x84(0xC)(IsPlainOldData, NoDestructor)
