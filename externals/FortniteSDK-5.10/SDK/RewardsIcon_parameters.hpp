...
public:
	...
	struct FLinearColor                          TintColor;                                         // 0x8(0x10)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	uint8                                        Pad_4687[0x3];                                     
	float                                        K2Node_CustomEvent_percent;                        // 0x2C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
