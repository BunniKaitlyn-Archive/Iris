...
// struct FRuntimeFloatCurve          K2Node_Select1_Default                                           ()

struct FRuntimeFloatCurve AB_SoundIndicator_01_C::GetWeaponCurve(bool Temp_bool_Variable, bool Temp_bool_Variable1, bool CallFunc_Greater_FloatFloat_ReturnValue, bool CallFunc_LessEqual_FloatFloat_ReturnValue, const struct FRuntimeFloatCurve& K2Node_Select_Default, const struct FRuntimeFloatCurve& K2Node_Select1_Default)
{
...
{
	static auto Func = Class->GetFunction("B_SoundIndicator_01_C", "UserConstructionScript");

	Params::AB_SoundIndicator_01_C_UserConstructionScript_Params Parms;
