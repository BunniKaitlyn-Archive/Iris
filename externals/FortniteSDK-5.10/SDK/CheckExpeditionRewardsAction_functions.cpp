...
{
	static auto Func = Class->GetFunction("CheckExpeditionRewardsAction_C", "UserConstructionScript");

	Params::ACheckExpeditionRewardsAction_C_UserConstructionScript_Params Parms;
