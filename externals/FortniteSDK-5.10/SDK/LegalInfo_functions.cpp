...
{
	static auto Func = Class->GetFunction("LegalInfo_C", "OnActivated");

	Params::ULegalInfo_C_OnActivated_Params Parms;
...
void ULegalInfo_C::ExecuteUbergraph_LegalInfo(int32 EntryPoint, bool CallFunc_IsTencentBuild_ReturnValue, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, class UCommonButton* K2Node_ComponentBoundEvent_Button, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UWidget* K2Node_ComponentBoundEvent_ActiveWidget, int32 K2Node_ComponentBoundEvent_ActiveWidgetIndex, class FName K2Node_ComponentBoundEvent_TabId, class UCommonButton* K2Node_ComponentBoundEvent_TabButton, class UEulaTab_C* K2Node_DynamicCast_AsEula_Tab, bool K2Node_DynamicCast_bSuccess, class UIconTextButton_C* K2Node_DynamicCast_AsIcon_Text_Button, bool K2Node_DynamicCast_bSuccess1, class UThirdPartyTab_C* K2Node_DynamicCast_AsThird_Party_Tab, bool K2Node_DynamicCast_bSuccess2, class UFortUINavigationManager* CallFunc_GetUINavigationManager_ReturnValue, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue, bool CallFunc_IsMobileGame_ReturnValue, class UWidget* CallFunc_GetActiveWidget_ReturnValue, enum class ESlateVisibility K2Node_Select_Default, class UThirdPartyTab_C* K2Node_DynamicCast_AsThird_Party_Tab1, bool K2Node_DynamicCast_bSuccess3, class UEulaTab_C* K2Node_DynamicCast_AsEula_Tab1, bool K2Node_DynamicCast_bSuccess4, bool CallFunc_SelectTabByID_ReturnValue)
{
