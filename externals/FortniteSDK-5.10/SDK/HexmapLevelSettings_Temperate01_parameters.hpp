...
struct AHexmapLevelSettings_Temperate01_C_UserConstructionScript_Params
{
public:
};
...
struct AHexmapLevelSettings_Temperate01_C_CustomSettings_Params
{
public:
...
struct AHexmapLevelSettings_Temperate01_C_ExecuteUbergraph_HexmapLevelSettings_Temperate01_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_CustomEvent_Visibility;                     // 0x4(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
