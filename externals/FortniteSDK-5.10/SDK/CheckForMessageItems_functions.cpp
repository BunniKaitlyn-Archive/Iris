...
{
	static auto Func = Class->GetFunction("CheckForMessageItems_C", "UserConstructionScript");

	Params::ACheckForMessageItems_C_UserConstructionScript_Params Parms;
