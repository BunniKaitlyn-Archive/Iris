...
{
	static auto Func = Class->GetFunction("B_Rift_Portals_C", "UserConstructionScript");
...
{
	static auto Func = Class->GetFunction("B_Rift_Portals_C", "BoostLight__FinishedFunc");

	Params::AB_Rift_Portals_C_BoostLight__FinishedFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Rift_Portals_C", "BoostLight__UpdateFunc");

	Params::AB_Rift_Portals_C_BoostLight__UpdateFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Rift_Portals_C", "ScaleLightOnOff__FinishedFunc");

	Params::AB_Rift_Portals_C_ScaleLightOnOff__FinishedFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Rift_Portals_C", "ScaleLightOnOff__UpdateFunc");

	Params::AB_Rift_Portals_C_ScaleLightOnOff__UpdateFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Rift_Portals_C", "OnPlaced");

	Params::AB_Rift_Portals_C_OnPlaced_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Rift_Portals_C", "OnRemoved");

	Params::AB_Rift_Portals_C_OnRemoved_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Rift_Portals_C", "OnSpawnAI");

	Params::AB_Rift_Portals_C_OnSpawnAI_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Rift_Portals_C", "Lightning Impact Event");

	Params::AB_Rift_Portals_C_Lightning_Impact_Event_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Rift_Portals_C", "OnActivated");

	Params::AB_Rift_Portals_C_OnActivated_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Rift_Portals_C", "ReceiveEndPlay");
...
{
	static auto Func = Class->GetFunction("B_Rift_Portals_C", "ReceiveBeginPlay");

	Params::AB_Rift_Portals_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Rift_Portals_C", "FadeLightIn");

	Params::AB_Rift_Portals_C_FadeLightIn_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Rift_Portals_C", "FadeLightOut");

	Params::AB_Rift_Portals_C_FadeLightOut_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Rift_Portals_C", "ManuallyActivateRift");

	Params::AB_Rift_Portals_C_ManuallyActivateRift_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Rift_Portals_C", "ManuallyDeactivateRift");

	Params::AB_Rift_Portals_C_ManuallyDeactivateRift_Params Parms;
...
// float                              RiftLightningDuration                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               SpawnImpactParticles                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void AB_Rift_Portals_C::PatrolEnemySuckIn(float Delay, float RiftLightningDuration, bool SpawnImpactParticles)
{
	static auto Func = Class->GetFunction("B_Rift_Portals_C", "PatrolEnemySuckIn");
...
{
	static auto Func = Class->GetFunction("B_Rift_Portals_C", "OnDeactivated");

	Params::AB_Rift_Portals_C_OnDeactivated_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Rift_Portals_C", "ResetGate");

	Params::AB_Rift_Portals_C_ResetGate_Params Parms;
...
// class ACar_Copper_C*               CallFunc_Array_Get_Item                                          (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
