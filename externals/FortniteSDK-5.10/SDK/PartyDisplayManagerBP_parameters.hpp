...
public:
	...
	uint8                                        Pad_55F5[0x3];                                     
	struct FVector                               CallFunc_Conv_FloatToVector_ReturnValue;           // 0x724(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_55FD[0x3];                                     
	struct FVector                               CallFunc_Conv_FloatToVector_ReturnValue1;          // 0x88C(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
