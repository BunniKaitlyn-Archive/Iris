...
public:
	...
	uint8                                        Pad_2C30[0x80];                                    
	struct FCatalogMetaAssetInfo                 MetaAssetInfo;                                     // 0x188(0x30)(NativeAccessSpecifierPublic)
	class FString                                DisplayAssetPath;                                  // 0x1B8(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FItemQuantity>                 ItemGrants;                                        // 0x1C8(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FCatalogOfferRequirement>      Requirements;                                      // 0x1D8(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	struct FCatalogGiftInfo                      GiftInfo;                                          // 0x1E8(0x28)(NativeAccessSpecifierPublic)
	bool                                         Refundable;                                        // 0x210(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_2C31[0x7];                                     
	TArray<class FString>                        DenyItemTemplateIds;                               // 0x218(0x10)(ZeroConstructor, Deprecated, NativeAccessSpecifierPrivate)
};
