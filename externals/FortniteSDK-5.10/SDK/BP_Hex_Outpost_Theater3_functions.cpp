...
{
	static auto Func = Class->GetFunction("BP_Hex_Outpost_Theater3_C", "UserConstructionScript");

	Params::ABP_Hex_Outpost_Theater3_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Hex_Outpost_Theater3_C", "ReceiveBeginPlay");

	Params::ABP_Hex_Outpost_Theater3_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Hex_Outpost_Theater3_C", "ActivateOutpost");

	Params::ABP_Hex_Outpost_Theater3_C_ActivateOutpost_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Hex_Outpost_Theater3_C", "HandleOnPlayerInfoChanged");
...
{
	static auto Func = Class->GetFunction("BP_Hex_Outpost_Theater3_C", "ExecuteUbergraph_BP_Hex_Outpost_Theater3");
