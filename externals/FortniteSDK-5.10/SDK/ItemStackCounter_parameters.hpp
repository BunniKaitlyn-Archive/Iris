...
public:
	...
	uint8                                        Pad_4E47[0x3];                                     
	struct FMargin                               CallFunc_GetMarginBySizeFromMultiSizeMargin_ReturnValue; // 0x14(0x10)(ConstParm, IsPlainOldData, NoDestructor)
	uint8                                        Pad_4E48[0x4];                                     
	struct FSlateBrush                           CallFunc_GetBrushBySizeFromMultiSizeBrush_ReturnValue; // 0x28(0x88)(ConstParm)
