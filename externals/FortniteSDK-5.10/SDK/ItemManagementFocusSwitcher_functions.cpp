...
// class UObject*                     CallFunc_BP_GetSelectedItem_ReturnValue2                         (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UObject*                     CallFunc_BP_GetSelectedItem_ReturnValue3                         (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                              CallFunc_GetNumItems_ReturnValue4                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                              CallFunc_GetNumItems_ReturnValue5                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UItemManagementFocusSwitcher_C::ExecuteFocusSwitch(int32 CallFunc_GetNumItems_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, int32 Temp_int_Variable, bool CallFunc_EqualEqual_ObjectObject_ReturnValue, class UFortUINavigationManager* CallFunc_GetUINavigationManager_ReturnValue, int32 CallFunc_GetNumItems_ReturnValue1, bool CallFunc_Greater_IntInt_ReturnValue1, class UObject* CallFunc_BP_GetSelectedItem_ReturnValue, int32 CallFunc_GetNumItems_ReturnValue2, class UObject* CallFunc_BP_GetSelectedItem_ReturnValue1, bool CallFunc_Greater_IntInt_ReturnValue2, bool Temp_bool_Variable, int32 CallFunc_GetNumItems_ReturnValue3, bool CallFunc_Greater_IntInt_ReturnValue3, int32 K2Node_Select_Default, class UObject* CallFunc_BP_GetSelectedItem_ReturnValue2, class UObject* CallFunc_BP_GetSelectedItem_ReturnValue3, int32 CallFunc_GetNumItems_ReturnValue4, int32 CallFunc_GetNumItems_ReturnValue5, bool CallFunc_Greater_IntInt_ReturnValue4, bool CallFunc_Greater_IntInt_ReturnValue5)
{
	...
	Parms.CallFunc_BP_GetSelectedItem_ReturnValue2 = CallFunc_BP_GetSelectedItem_ReturnValue2;
	Parms.CallFunc_BP_GetSelectedItem_ReturnValue3 = CallFunc_BP_GetSelectedItem_ReturnValue3;
	Parms.CallFunc_GetNumItems_ReturnValue4 = CallFunc_GetNumItems_ReturnValue4;
	Parms.CallFunc_GetNumItems_ReturnValue5 = CallFunc_GetNumItems_ReturnValue5;
...
void UItemManagementFocusSwitcher_C::DeferFocusSwitch(const struct FTimerHandle& CallFunc_K2_SetTimer_ReturnValue, bool CallFunc_IsValid_ReturnValue, class UObject* CallFunc_BP_GetSelectedItem_ReturnValue, bool CallFunc_IsValid_ReturnValue1)
{
