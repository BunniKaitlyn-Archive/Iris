...
public:
	...
	uint8                                        Pad_2D4A[0x6];                                     
	struct FTimerHandle                          CallFunc_K2_SetTimer_ReturnValue;                  // 0x180(0x8)(NoDestructor)
	...
	uint8                                        Pad_2D4D[0x7];                                     
	class FName                                  CallFunc_MakeLiteralName_ReturnValue1;             // 0x1B8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ESlateVisibility                  Temp_byte_Variable1;                               // 0x1C0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_2D4E[0x3];                                     
	...
	enum class ESlateVisibility                  Temp_byte_Variable2;                               // 0x1C9(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	enum class ESlateVisibility                  Temp_byte_Variable3;                               // 0x1CB(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         Temp_bool_Variable1;                               // 0x1CC(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_2D4F[0x3];                                     
	class FText                                  CallFunc_Conv_FloatToText_ReturnValue;             // 0x1D0(0x18)()
	...
	uint8                                        Pad_2D50[0x2];                                     
	float                                        CallFunc_GetSettingValueSlider_ReturnValue;        // 0x1EC(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        K2Node_Select2_Default;                            // 0x1F0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_Multiply_FloatFloat_ReturnValue;          // 0x1F4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FText                                  CallFunc_Conv_FloatToText_ReturnValue1;            // 0x1F8(0x18)()
};
