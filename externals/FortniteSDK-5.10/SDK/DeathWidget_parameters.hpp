...
public:
	...
	class AFortPlayerControllerDeployableBase*   K2Node_DynamicCast_AsFort_Player_Controller_Deployable_Base; // 0x8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0x10(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_2E0A[0x7];                                     
	...
	class AFortPlayerStateZone*                  CallFunc_GetPlayerStateZone_ReturnValue;           // 0x58(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         CallFunc_GetFloatAttributeFromAbilitySystemComponent_bSuccessfullyFoundAttribute; // 0x79(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_2E0B[0x2];                                     
	...
	bool                                         CallFunc_BooleanAND_ReturnValue1;                  // 0xF8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_2E0E[0x7];                                     
	class FText                                  CallFunc_Format_ReturnValue;                       // 0x100(0x18)()
	struct FSlateColor                           K2Node_MakeStruct_SlateColor;                      // 0x118(0x28)()
	struct FSlateColor                           K2Node_MakeStruct_SlateColor1;                     // 0x140(0x28)()
};
