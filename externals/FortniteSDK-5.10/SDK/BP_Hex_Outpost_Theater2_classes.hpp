...
public:
	...
	class UStaticMeshComponent*                  StaticMesh1;                                       // 0x6E8(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	{
		static class UClass* Clss = UObject::FindClassFast("BP_Hex_Outpost_Theater2_C");
		return Clss;
	}
