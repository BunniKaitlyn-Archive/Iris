...
{
public:
	struct FPointerToUberGraphFrame              UberGraphFrame;                                    // 0x548(0x8)(Transient, DuplicateTransient)
	TArray<struct FTutorialHighlightData>        SentencedIndexedTutorialData;                      // 0x550(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
