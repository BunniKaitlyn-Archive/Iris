...
void UVoteUpdateNotificationWidget_C::OnVoteStarted(enum class EFortVoteType VoteType, int32 YesVoteCount, int32 NoVoteCount)
{
...
void UVoteUpdateNotificationWidget_C::OnVoteEnded(enum class EFortVoteType VoteType, bool VoteSucceeded)
{
...
void UVoteUpdateNotificationWidget_C::ExecuteUbergraph_VoteUpdateNotificationWidget(int32 EntryPoint, enum class EFortVoteType K2Node_Event_VoteType, bool K2Node_Event_VoteSucceeded, enum class EFortVoteType K2Node_Event_VoteType1, int32 K2Node_Event_YesVoteCount, int32 K2Node_Event_NoVoteCount, enum class EFortVoteType K2Node_Event_VoteType2, int32 K2Node_Event_YesVoteCount1, int32 K2Node_Event_NoVoteCount1, bool CallFunc_EqualEqual_ByteByte_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue1, class UCommonButton* K2Node_ComponentBoundEvent_Button, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, class UMissionActivationWidget_C* CallFunc_Create_ReturnValue, bool CallFunc_IsUsingGamepad_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_BooleanAND_ReturnValue1)
{
