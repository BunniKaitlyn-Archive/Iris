...
public:
	...
	int32                                        CallFunc_GetNumInInventory_ReturnValue1;           // 0x34(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
{
public:
	TArray<class UFortWorldItem*>                Items_Added;                                       // 0x0(0x10)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm)
	TArray<class UFortWorldItem*>                Items_Removed;                                     // 0x10(0x10)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm)
};
...
{
public:
	class UFortWorldItem*                        New_Item;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	bool                                         CallFunc_IsValid_ReturnValue1;                     // 0x4B(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
