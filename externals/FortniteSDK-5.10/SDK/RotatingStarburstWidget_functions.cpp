...
{
	static auto Func = Class->GetFunction("RotatingStarburstWidget_C", "Tick");
...
{
	static auto Func = Class->GetFunction("RotatingStarburstWidget_C", "ExecuteUbergraph_RotatingStarburstWidget");
