...
struct UAnimNotify_AllowKnockback_C_Received_Notify_Params
{
public:
	...
	int32                                        CallFunc_RemoveActiveEffectsWithTags_ReturnValue;  // 0x38(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
