...
{
	static auto Func = Class->GetFunction("AnimNotifyState_DisableSteering_C", "Received_NotifyEnd");
...
{
	static auto Func = Class->GetFunction("AnimNotifyState_DisableSteering_C", "Received_NotifyBegin");
