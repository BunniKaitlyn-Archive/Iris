...
public:
	...
	class UParticleSystemComponent*              FuryPS;                                            // 0x428(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TMap<class FName, float>                     ScalarParameters;                                  // 0x480(0x50)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
