...
{
	static auto Func = Class->GetFunction("BP_AnimNotifyState_CameraAnim_C", "Received_NotifyEnd");
...
{
	static auto Func = Class->GetFunction("BP_AnimNotifyState_CameraAnim_C", "Received_NotifyBegin");
