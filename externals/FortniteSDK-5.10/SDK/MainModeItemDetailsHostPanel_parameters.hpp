...
struct UMainModeItemDetailsHostPanel_C_Construct_Params
{
public:
};
...
struct UMainModeItemDetailsHostPanel_C_ExecuteUbergraph_MainModeItemDetailsHostPanel_Params
{
public:
	...
	enum class ESlateVisibility                  K2Node_Select1_Default;                            // 0xB(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
