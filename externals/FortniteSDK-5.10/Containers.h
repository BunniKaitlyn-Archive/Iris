...
// FMemory
inline void* (*FMemory_Malloc)(int32 Size, int32 Alignment) = decltype(FMemory_Malloc)(uintptr_t(GetModuleHandle(0)) + 0x1539E40);
inline void* (*FMemory_Realloc)(void* Memory, int64 NewSize, uint32 Alignment) = decltype(FMemory_Realloc)(uintptr_t(GetModuleHandle(0)) + 0x153C420);
inline void  (*FMemory_Free)(void* Memory) = decltype(FMemory_Free)(uintptr_t(GetModuleHandle(0)) + 0x152E830);
...
namespace UE
{
    ...
    public:
        ...
        TArray(int InitMax)
            ...
            , MaxElements(InitMax)
        {
            Data = FMemory_Malloc(InitMax * sizeof(ArrayType), alignof(ArrayType));
        }
        ...
        {
            Data = Slack() >= NumElements ? Data : (ArrayType*)FMemory_Realloc(Data, (MaxElements = Count + NumElements) * sizeof(ArrayType), 0);
        }
        FORCEINLINE void Reset(int MinSizeAfterReset = 5)
        {
            ...
            Data = (ArrayType*)FMemory_Malloc(MinSizeAfterReset * sizeof(ArrayType), alignof(ArrayType));
        }
